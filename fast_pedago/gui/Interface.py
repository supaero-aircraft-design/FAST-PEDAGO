...
class Interface:
    ...
    # MAIN FAST-OAD ANALYSIS INTERFACE
    ...
    def Menu(self):
        ...
        layout_box = Layout(
            width="100%", height="40%", align_items="center", justify_content="center"
        )
        layout_title = widgets.Layout(
            align_items="center", justify_content="center", width="65%", height="50%"
        )
        self.Button_M0 = widgets.Button(
            description="DEMO", layout=layout_button, style=dict(button_color="#00d600")
        )
        self.Button_M1 = widgets.Button(
            description=table[0],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        self.Button_M2 = widgets.Button(
            description=table[1],
            layout=layout_button,
            disabled=True,
            style=dict(button_color="#ebebeb"),
        )
        self.Button_M3 = widgets.Button(
            description=table[2],
            layout=layout_button,
            disabled=True,
            style=dict(button_color="#ebebeb"),
        )
        self.Button_M4 = widgets.Button(
            description=table[3],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        self.Button_M5 = widgets.Button(
            description=table[4],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        self.Button_M6 = widgets.Button(
            description=table[5],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        self.Button_M7 = widgets.Button(
            description=table[6],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "Welcome to FAST-OAD Training Branch.\n"
        ...
        def open_github_CS25(event):
            ...
            webbrowser.open_new_tab(
                "https://github.com/fast-aircraft-design/FAST-OAD_CS25"
            )
        ...
        box_buttons_git = widgets.HBox(
            children=[button_git_FAST, button_git_CS25, button_git_GA],
            layout=Layout(
        ...
        self.menu = widgets.VBox(
            children=[box1, box_buttons_git, box2, box3, box4],
            layout=Layout(
    ...
    # This function is used to go to the demo interface when clickig DEMO button in the main menu
    ...
    # This function provides an interface containing 3 main buttons to redirect into different Learning Environments.
    # This function is called in the previous function
    def demo_models(self):
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "Welcome to the Learning Environment DEMO.\n"
        ...
        Button_basis = widgets.Button(
            description="Performance Basis",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        Button_basis.on_click(self.demo_basis)

        Button_Exo = widgets.Button(
            description="Impact Variables",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        Button_Exo.on_click(self.demo_exo)

        self.BOX_INPUT = widgets.VBox(
            children=[box1, box4, Button_demo, Button_basis, Button_Exo],
            layout=Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
    ...
    # This is the function that contains Inspect modules
    # Here, data is retrieved, computed and displayed.
    def demo_modules(self, event=None):
        ...
        layout = widgets.Layout(
            width="75%", height="50px", justify_content="space-between"
        )
        style = style = {"description_width": "initial"}
        layout_button = widgets.Layout(
            width="30%", height="50px", border="4px solid black"
        )
        layout_box = widgets.Layout(
            border="6px solid black", padding="10px", align_items="center", width="100%"
        )
        ...
        self.CAB_1 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.C_value1,
            description="seats:width [m]",
            description_tooltip="Economical width",
            style=style,
            layout=layout,
        )
        self.CAB_2 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.C_value2,
            description="seats:length [m]",
            description_tooltip="Economical width",
            style=style,
            layout=layout,
        )
        self.CAB_3 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=self.C_value3,
            description="seats:by_row [-]",
            description_tooltip="Number of seats per row",
            style=style,
            layout=layout,
        )
        self.CAB_4 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.C_value4,
            description="cabin:aisle_width [m]",
            description_tooltip="Width of the aisle",
            style=style,
            layout=layout,
        )
        self.CAB_5 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.C_value5,
            description="cabin:exit_width [m]",
            description_tooltip="Cabins exit width",
            style=style,
            layout=layout,
        )
        self.CAB_6 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=self.C_value6,
            description="NPAX [-]",
            description_tooltip="Number of passanger from TLARS",
            style=style,
            layout=layout,
        )
        self.CAB_7 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=self.C_value7,
            description="engine:count [-]",
            description_tooltip="Number of engines",
            style=style,
            layout=layout,
        )

        self.CAB_1_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="cabin:NPAX1",
            description_tooltip="Updated number of Pax",
            style=style,
            layout=layout,
            width="150px",
        )

        self.CAB_2_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="flight_kit:CG:x [m]",
            description_tooltip="CG of flight kit",
            style=style,
            layout=layout,
            width="150px",
        )
        self.CAB_3_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="pax_seats:CG:x [m]",
            description_tooltip="CG of passenger seat",
            style=style,
            layout=layout,
        )
        self.CAB_4_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:length [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_5_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:max_width [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_6_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:max_height [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_7_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:front_length [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_8_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:rear_length [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_9_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:PAX_length [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_10_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="cabin:length [m]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_11_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="crew_count:commercial [-]",
            description_tooltip="",
            style=style,
            layout=layout,
        )
        self.CAB_12_OUT = widgets.BoundedFloatText(
            min=0,
            max=1000,
            value=0,
            disabled=True,
            description="fuselage:wetted_area [m^2]",
            description_tooltip="",
            style=style,
            layout=layout,
            width="150px",
        ...
        def update_fus(event):
            front_seat_number_eco = (
                self.CAB_3.value
            )  # inputs["data:geometry:cabin:seats:economical:count_by_row"]
            ws_eco = (
                self.CAB_1.value
            )  # inputs["data:geometry:cabin:seats:economical:width"]
            ls_eco = (
                self.CAB_2.value
            )  # inputs["data:geometry:cabin:seats:economical:length"]
        ...
        C_inout_inter = widgets.HBox(
            children=[C_input, C_output], align_items="space-between"
        )
        ...
        C_img1 = widgets.Image(
            value=C_image1, format="PNG", width="100%", height="100%"
        )
        C_img2 = widgets.Image(
            value=C_image2, format="PNG", width="100%", height="100%"
        )
        C_img3 = widgets.Image(
            value=C_image3, format="PNG", width="100%", height="100%"
        )
        ...
        # TO DO: For all modules
        # IDEA: In another script rewrite the Inspect Modules and then call the results in the Interface
        ################################################################################################################
    ...
    # demo_basis contains the Performance Basis section, with three different tabs (Breguet, MassLoop, Constraint)
    def demo_basis(self, event=None):
        ...
        self.Breguet_1 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.Breguet_value1,
            description="Finesse L/D",
            description_tooltip="Mean Lift/Drag ratio",
            style=style,
            layout=layout,
        )
        self.Breguet_2 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.Breguet_value2,
            description="Velocity [km/h]",
            description_tooltip="Aircraft True Airspeed",
            style=style,
            layout=layout,
        )
        self.Breguet_3 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=self.Breguet_value3,
            description="SFC [kg/N/h]",
            description_tooltip="Specific Fuel Consumption (Flue flow per unit of thrust)",
            style=style,
            layout=layout,
        )
        self.Breguet_4 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.Breguet_value4,
            description="Initial Weight (TOW) [kg]",
            description_tooltip="Initial aircraft weight",
            style=style,
            layout=layout,
        )
        self.Breguet_5 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.Breguet_value5,
            description="Final Weight (LW) [kg]",
            description_tooltip="Final aircraft weight",
            style=style,
            layout=layout,
        )
        self.Breguet_6 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.Breguet_value6,
            description="OWE/MTOW",
            description_tooltip="OWE and MTOW ratio",
            style=style,
            layout=layout,
        )
        self.Breguet_7 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.Breguet_value7,
            description="Reserve/MLW",
            description_tooltip="Fuel Reserve and Max Landing Weight ratio",
            style=style,
            layout=layout,
        )
        self.Breguet_8 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.Breguet_value8,
            description="Payload [kg]",
            description_tooltip="Aircraft payload",
            style=style,
            layout=layout,
        )
        self.Breguet_9 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.Breguet_value9,
            description="Range [km]",
            description_tooltip="Desired range",
            style=style,
            layout=layout,
        )

        self.Breguet_Range_1_OUT = widgets.BoundedFloatText(
            min=0,
            max=20000,
            value=0,
            disabled=True,
            description="Aircraft Range [km]",
            description_tooltip="Aircraft range in km",
            style=style,
            layout=layout,
            width="150px",
        )
        self.Breguet_Range_2_OUT = widgets.BoundedFloatText(
            min=0,
            max=20000,
            value=0,
            disabled=True,
            description="Aircraft Range [NM]",
            description_tooltip="Aircraft range in Nautical miles",
            style=style,
            layout=layout,
            width="150px",
        )

        self.Breguet_Masses_1_OUT = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Take off Weight [kg]",
            description_tooltip="Maximum or Take off weight",
            style=style,
            layout=layout,
            width="150px",
        )
        self.Breguet_Masses_2_OUT = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Fuel Weight [kg]",
            description_tooltip="Fuel weight including reserve fuel",
            style=style,
            layout=layout,
            width="150px",
        )
        self.Breguet_Masses_3_OUT = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Reserve Fuel Weight [kg]",
            description_tooltip="Reserve of fuel weight",
            style=style,
            layout=layout,
            width="150px",
        )
        self.Breguet_Masses_4_OUT = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="OWE [kg]",
            description_tooltip="Operational Weight Empty",
            style=style,
            layout=layout,
            width="150px",
        )
        self.Breguet_Masses_5_OUT = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="LW [kg]",
            description_tooltip="Maximum or Landing Weight",
            style=style,
            layout=layout,
            width="150px",
        )
        self.Breguet_Masses_6_OUT = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="MF/MTOW [kg]",
            description_tooltip="Ratio between Mass fuel and Take off weight",
            style=style,
            layout=layout,
            width="150px",
        )
        ...
        def update_breguet(event):
            ...
            g = 9.8066  # m/s^2
            range = V * finesse * np.log(Wi / Wf) / (g * SFC)  # km
            ...
            ratio_Weight_i_f = np.exp((Range_2 * g * SFC) / (V * finesse))
            ...
            self.Breguet_Range_2_OUT.value = round(
                range * 0.5395680, 3
        ...
        C_box2_Out = widgets.VBox(
            children=[
                self.Breguet_Masses_1_OUT,
                self.Breguet_Masses_2_OUT,
                self.Breguet_Masses_3_OUT,
                self.Breguet_Masses_4_OUT,
                self.Breguet_Masses_5_OUT,
                self.Breguet_Masses_6_OUT,
            ],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
        ...
        Breguets_2nd_Title = widgets.HTML(
            value=" <b>  Breguet's Formulation with range as input </b>"
        )
        ...
        self.C_basis_box = widgets.VBox(
            children=[
                button_Update_Breguet,
                C_img1,
                C_inout_inter,
                C_box_inter,
                Breguets_2nd_Title,
        ...
        self.MassLoop_1_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.MassLoop_value1_min,
            description="MTOW- MIN [kg]",
            description_tooltip="Min take off weight",
            style=style,
            layout=layout,
        )
        self.MassLoop_2_min = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.1,
            value=self.MassLoop_value2_min,
            description="Span [m]",
            description_tooltip="The span of the wing",
            style=style,
            layout=layout,
        )

        self.MassLoop_3_min = widgets.BoundedFloatText(
            min=0,
            max=5000,
            step=1,
            value=self.MassLoop_value3_min,
            description="Wing Area [m^2]",
            description_tooltip="Area of the wing in square meters",
            style=style,
            layout=layout,
        )
        self.MassLoop_4_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.MassLoop_value4_min,
            description="t/c",
            description_tooltip="Relative thickness",
            style=style,
            layout=layout,
        )
        self.MassLoop_5_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.MassLoop_value5_min,
            description="Quarter chord sweep [º]",
            description_tooltip="Quarter chord sweep at 25% of MAC",
            style=style,
            layout=layout,
        )
        self.MassLoop_6_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.MassLoop_value6_min,
            description="Engine weight x2 [kg]",
            description_tooltip="Weight of the engines",
            style=style,
            layout=layout,
        )

        self.MassLoop_7_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=10,
            value=self.MassLoop_value7_min,
            description="Npax",
            description_tooltip="Number of passenger",
            style=style,
            layout=layout,
        )

        self.MassLoop_1_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.MassLoop_value1_max,
            description="MTOW- MAX [kg]",
            description_tooltip="Maximum takee off weight",
            style=style,
            layout=layout,
        )

        self.MassLoop_1_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="OWE min [kg]",
            description_tooltip="Operational Weight Empty for Min MTOW",
            style=style,
            layout=layout,
            width="150px",
        )
        self.MassLoop_2_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Operator items min [kg]",
            description_tooltip="Weight of the operational items",
            style=style,
            layout=layout,
            width="150px",
        )
        self.MassLoop_3_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Wing weight min [kg]",
            description_tooltip="Weight of the wing",
            style=style,
            layout=layout,
            width="150px",
        )
        self.MassLoop_4_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Fuselage weight min [kg]",
            description_tooltip="Weight of the fuselage",
            style=style,
            layout=layout,
            width="150px",
        )
        self.MassLoop_5_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MassLoop_6_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
            description="Landing gear weight min [kg]",
            description_tooltip="Weight of the landing gear",
            style=style,
            layout=layout,
            width="150px",
        )

        self.MassLoop_1_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MassLoop_2_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MassLoop_3_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MassLoop_4_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MassLoop_5_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MassLoop_6_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            value=0,
            disabled=True,
        ...
        self.MissionLoop_3 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Breguet_value1,
            disabled=True,
            description="L/D",
            description_tooltip="Finesse",
            style=style,
            layout=layout,
        )
        self.MissionLoop_4 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Breguet_value2,
            disabled=True,
            description="Velocity [km/h]",
            description_tooltip="Aircrafts true airspeed",
            style=style,
            layout=layout,
        )
        self.MissionLoop_5 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Breguet_value3,
            disabled=True,
            description="SFC [kg/N/h]",
            description_tooltip="Specific fuel consumption",
            style=style,
            layout=layout,
        )
        self.MissionLoop_6 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Breguet_value7,
            disabled=True,
            description="Reserve / ZFW ",
            description_tooltip="Fuel reserve ratio",
            style=style,
            layout=layout,
        )
        self.MissionLoop_7 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Breguet_value9,
            disabled=True,
            description="Range [km]",
            description_tooltip="Aircrafts range",
            style=style,
            layout=layout,
        )
        self.MissionLoop_8 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.MassLoop_value_NpaxKg,
            description="Payload units [kg/pax]",
            description_tooltip="Aircrafts range",
            style=style,
            layout=layout,
        )

        self.MissionLoop_1_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=0,
        ...
        self.MissionLoop_2_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=0,
            disabled=True,
            description="LW- MIN [kg]",
            description_tooltip="Landing Weight",
            style=style,
            layout=layout,
        )
        self.MissionLoop_3_OUT_min = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=0,
            disabled=True,
            description="ZFW- MIN [kg]",
            description_tooltip="Zero Fuel Weight",
            style=style,
            layout=layout,
        )

        self.MissionLoop_1_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=0,
        ...
        self.MissionLoop_2_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=0,
            disabled=True,
            description="LW- MAX [kg]",
            description_tooltip="Landing Weight",
            style=style,
            layout=layout,
        )
        self.MissionLoop_3_OUT_max = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=0,
            disabled=True,
            description="ZFW- MAX [kg]",
            description_tooltip="Zero Fuel Weight",
            style=style,
            layout=layout,
        )
        ...
        self.y_mission = [
            self.MissionLoop_1_OUT_min.value,
            self.MissionLoop_1_OUT_max.value,
        ]

        self.fig.add_trace(
            go.Scatter(name="Mass", x=self.x, y=self.y, mode="lines+markers")
        )
        self.fig.add_trace(
            go.Scatter(
                name="Mission", x=self.x_mission, y=self.y_mission, mode="lines+markers"
            )
        )
        # set axis labels
        ...
        def update_massloop(event):
            ...
            e = np.cos(self.MassLoop_5_min.value * 3.1416 / 180) ** (-1)
            ...
            exponent = np.exp(
                (self.Breguet_9.value * 9.8066 * self.Breguet_3.value)
                / (self.Breguet_2.value * self.Breguet_1.value)
            )
            ...
            m1 = (self.MassLoop_1_OUT_max.value - self.MassLoop_1_OUT_min.value) / (
                self.MassLoop_1_max.value - self.MassLoop_1_min.value
            )
            m2 = (
                self.MissionLoop_1_OUT_max.value - self.MissionLoop_1_OUT_min.value
            ) / (self.MassLoop_1_max.value - self.MassLoop_1_min.value)
            ...
            print(
                ...
                + " MTOW= "
                + str(round(X_converged, 3))
                + " kg "
                + " OWE= "
                + str(round(Y_converged, 3))
                + " kg"
            )
        ...
        C_box_massloop_Out_Min = widgets.VBox(
            children=[
                self.MassLoop_1_OUT_min,
                self.MassLoop_2_OUT_min,
                self.MassLoop_3_OUT_min,
                self.MassLoop_4_OUT_min,
                self.MassLoop_5_OUT_min,
                self.MassLoop_6_OUT_min,
                self.MassLoop_1_OUT_max,
                self.MassLoop_2_OUT_max,
                self.MassLoop_3_OUT_max,
                self.MassLoop_4_OUT_max,
                self.MassLoop_5_OUT_max,
                self.MassLoop_6_OUT_max,
            ],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
        ...
        C_box_inter_massloop_min = widgets.HBox(
            children=[C_box_massloop_Min, C_box_massloop_Out_Min], layout=layout_box
        )
        ...
        C_box_missionloop_Out = widgets.VBox(
            children=[
                self.MissionLoop_1_OUT_min,
                self.MissionLoop_2_OUT_min,
                self.MissionLoop_3_OUT_min,
                self.MissionLoop_1_OUT_max,
                self.MissionLoop_2_OUT_max,
                self.MissionLoop_3_OUT_max,
            ],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
        ...
        C_box_inter_missionloop = widgets.HBox(
            children=[C_box_missionloop, C_box_missionloop_Out], layout=layout_box
        )
        ...
        self.C_basis_massloop_box = widgets.VBox(
            children=[
                button_Update_Massloop,
                C_massloop1,
                C_box_inter_massloop_min,
                C_massloop2,
                C_box_inter_missionloop,
                C_massloop3,
            ],
            layout=layout_box,
        )
        ...
        self.Constraint_1_Density = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_density_at_stall,
            description="Density [kg/m^3]",
            description_tooltip="Density at desired altitude",
            style=style,
            layout=layout,
        )
        self.Constraint_2_Clmax = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_Clmax,
            description="Cl max",
            description_tooltip="Max lift coefficient",
            style=style,
            layout=layout,
        )
        self.Constraint_3_TOP = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_TOP,
            description="TOP",
            description_tooltip="Take Off Parameter",
            style=style,
            layout=layout,
        )
        self.Constraint_4_Density_TO = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_density_to,
            description="Density TO [kg/m^3]",
            description_tooltip="Density at take off",
            style=style,
            layout=layout,
        )
        self.Constraint_5_Density_SL = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_density_sl,
            description="Density SL[kg/m^3]",
            description_tooltip="Density at sea level",
            style=style,
            layout=layout,
        )
        self.Constraint_6_CL_TO = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_CL_TO,
            description="Cl Take off",
            description_tooltip="Lift Coefficient at Take off",
            style=style,
            layout=layout,
        )

        self.Constraint_7_Cd0 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_Cd0,
            description="Drag Cd0",
            description_tooltip="Cd0 coefficient",
            style=style,
            layout=layout,
        )
        self.Constraint_8_e = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_e,
            description="Oswalt factor",
            description_tooltip="Drag lift correction facotr for 3d wings",
            style=style,
            layout=layout,
        )
        self.Constraint_9_density_FL = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_density_fl,
            description="Density FL [kg/m^3]",
            description_tooltip="Density at cruise altitude",
            style=style,
            layout=layout,
        )
        self.Constraint_10_climb_rate = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_climb_rate,
            description="dh/dt [m/s]",
            description_tooltip="Climbing rate",
            style=style,
            layout=layout,
        )
        self.Constraint_11_climb_velocity = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_climbing_vel,
            description="V climb [m/S]",
            description_tooltip="Climb phase velocity",
            style=style,
            layout=layout,
        )
        self.Constraint_12_density_CL = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_density_climbing,
            description="Density Climbing [kg/m^3]",
            description_tooltip="Density at cruise altitude",
            style=style,
            layout=layout,
        )
        self.Constraint_13_n = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Constraint_n,
            description="Load factor n",
            description_tooltip="Load factor",
            style=style,
            layout=layout,
        )
        ...
        def update_constraint(event):
            ...
            density_ratio_sigma = (
                self.Constraint_4_Density_TO.value / self.Constraint_5_Density_SL.value
            )
            # create vector Wing loading
            W_S_to = np.linspace(0, 9000, num=100)
            T_W_TakeOff = W_S_to / (
                self.Constraint_3_TOP.value
                * density_ratio_sigma
                * self.Constraint_6_CL_TO.value
            )
            ...
            fig.add_trace(
                go.Scatter(name="V stall", x=x_stall, y=y_stall, mode="lines+markers")
            )
            fig.add_trace(
                go.Scatter(
                    name="Take Off", x=x_takeoff, y=y_takeoff, mode="lines+markers"
                )
            )
            fig.add_trace(
                go.Scatter(
            ...
            fig.add_trace(
                go.Scatter(
                    name="Climbing", x=x_climbing, y=y_climbing, mode="lines+markers"
                )
            )
        ...
        C_box_constraint_stall = widgets.VBox(
            children=[self.Constraint_1_Density, self.Constraint_2_Clmax],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        C_box_constraint_takeoff = widgets.VBox(
            children=[
                self.Constraint_3_TOP,
                self.Constraint_4_Density_TO,
                self.Constraint_5_Density_SL,
                self.Constraint_6_CL_TO,
            ],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
        ...
        C_box_constraint_level = widgets.VBox(
            children=[
                self.Constraint_7_Cd0,
                self.Constraint_8_e,
                self.Constraint_9_density_FL,
            ],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
        ...
        C_box_constraint_climb = widgets.VBox(
            children=[
                self.Constraint_10_climb_rate,
                self.Constraint_11_climb_velocity,
                self.Constraint_12_density_CL,
                self.Constraint_13_n,
            ],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
        ...
        self.C_basis_constraint_box = widgets.VBox(
            children=[
                button_Update_Constraint,
                C_constraint1,
                C_box_constraint_stall,
                C_constraint2,
                C_box_constraint_takeoff,
                C_constraint4,
                C_box_constraint_climb,
                C_constraint5,
                C_box_constraint_level,
            ],
            layout=layout_box,
        )

        # GENERAL INPUTS MENU for BASIS LEARNING FEATURE
        self.tab_Basis_IN = widgets.Tab(
            children=[
                self.C_basis_box,
                self.C_basis_massloop_box,
                self.C_basis_constraint_box,
            ]
        )
    ...
    # This function calculates the compact MDA problem with few variables
    def demo_exo(self, event=None):
        ...
        # To generate a specific Input file for this section
        ...
        self.In_Variable_Exo_1 = widgets.BoundedFloatText(
            ...
            max=900000,
            step=0.1,
            value=self.Variable_Exo_1,
            description="Npax",
            description_tooltip="Number of Passengers",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_2 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_2,
            description="Vapp ",
            description_tooltip="Approach speed [m/s]",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_3 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_3,
            description="Mcr",
            description_tooltip="Cruise mach",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_4 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_4,
            description="Range",
            description_tooltip="Aircraft range  [NM]",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_5 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_5,
            description="Max PL ",
            description_tooltip="Maximum payload [kg]",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_6 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_6,
            description="PL ",
            description_tooltip="Payload [kg]",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_7 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_7,
            description="AR",
            description_tooltip="Aspect ratio",
            style=style,
            layout=layout,
        )
        self.In_Variable_Exo_8 = widgets.BoundedFloatText(
            min=0,
            max=900000,
            step=0.1,
            value=self.Variable_Exo_8,
            description="BPR",
            description_tooltip="Bypass ratio of the engine",
            style=style,
            layout=layout,
        )
        self.StudyName = widgets.Text(
            description="NAME",
            placeholder="Write a name for you modification",
            style=style,
            layout=layout,
        )
        ...
        def save_variable_interests(event):
            ...
            ].value = self.In_Variable_Exo_2.value
            ...
            ].value = self.In_Variable_Exo_5.value
            self.INPUT_EXO[
                "data:weight:aircraft:payload"
            ].value = self.In_Variable_Exo_6.value
            self.INPUT_EXO[
                "data:geometry:wing:aspect_ratio"
            ].value = self.In_Variable_Exo_7.value
            self.INPUT_EXO[
                "data:propulsion:rubber_engine:bypass_ratio"
            ].value = self.In_Variable_Exo_8.value

            self.INPUT_EXO.save()
            List_StudyName.append(self.StudyName)
            print("The variables have been updated")

        self.button_Update_Variables = widgets.Button(
            description="Update VoI", description_tooltip="Update Variables of Interest"
        )
        ...
        # here, after this save function, the new values modified by the user are changed in the input file

        # This function run de MDA and save the output and mission files
        def RUN_MDA_EXO_Function():
            MDA_problem_exo = self.OAD.RUN_OAD_EXO()  # This runs the MDA problem
            self.OAD.Save_File(
                MDA_problem_exo.output_file_path,
                "OUTPUT\OUTPUT_EXO",
                str(self.StudyName.value),
            )
            self.OAD.Save_CSV_File(
                "File\workdir\oad_sizing.csv",
                "OUTPUT\OUTPUT_EXO",
                str(self.StudyName.value),
            )
            return MDA_problem_exo

        # Function to update the progress bar used in LAUNCH (no performance)
        def update_progress_bar():
            ...
            with progressbar.ProgressBar(
                widgets=custom_widget, max_value=total_iterations
            ) as bar:
        ...
        # This is used to call for the start of the execution of MDA at the same time the the progressbar is updated
        # No performance module
        def RUN_MDA_EXO(event):
            ...
            self.output_list_exo_xml = widgets.SelectMultiple(
                options=path_to_file_list_xml,
                description="Select an Aircraft:",
                disabled=False,
                style={"description_width": "initial"},
                layout=widgets.Layout(width="300px", height="150 px"),
                rows=len(path_to_file_list_xml),
            )
            self.C_select = widgets.HBox(
                children=[self.output_list_exo_xml, button_plots],
                layout=widgets.Layout(
        ...
        # Function to update the progress bar for the performance module
        ...
        self.button_Run_Exo = widgets.Button(
            description="LAUNCH",
            tooltip="This will not compute the performance. Hence, the payload-range will not be available",
        )
        ...
        # here we run the EXO problem
        self.button_Run_Exo_Perfo = widgets.Button(
            description="LAUNCH Performance", tooltip="Performance module included"
        )
        ...
        self.tab_Analysis_Exo_1 = widgets.Tab(
            children=[
                self.fig1,
                self.fig2,
                self.fig3,
        ...
        C_Vertical_box1 = widgets.VBox(
            children=[
                C_exo1,
                C_exo1_1,
                self.In_Variable_Exo_1,
                self.In_Variable_Exo_2,
                self.In_Variable_Exo_3,
                self.In_Variable_Exo_4,
                C_exo1_2,
                self.In_Variable_Exo_5,
                self.In_Variable_Exo_6,
                C_exo1_3,
                self.In_Variable_Exo_7,
                C_exo1_4,
                self.In_Variable_Exo_8,
                self.StudyName,
                self.button_Update_Variables,
            ],
            layout=widgets.Layout(
                border="2px solid black",
                align_items="center",
        ...
        C_Vertical_box2 = widgets.VBox(
            children=[C_exo2, self.tab_Analysis_Exo_1],
            layout=widgets.Layout(
                border="2px solid black",
                align_items="center",
                padding="5px",
        ...
        self.C_Horizontal_box1 = widgets.HBox(
            children=[self.button_Run_Exo, self.button_Run_Exo_Perfo],
            layout=widgets.Layout(
                border="2px solid black",
                align_items="center",
                justify_content="space-around",
        ...
        self.C_Horizontal_box2 = widgets.HBox(
            children=[C_Vertical_box1, C_Vertical_box2],
            layout=widgets.Layout(
                border="2px solid black",
                align_items="center",
                padding="5px",
        ...
        self.Vertical_box3 = widgets.VBox(
            children=[self.C_Horizontal_box1, self.C_Horizontal_box2],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="5px",
    ...
    # After launching the mda this function is called to update the data of the diagrams
    def UpdatePlots(self, event):
        ...
        self.fig4 = self.OAD.payload_range(
            XML_Liste_Design[0], CSV_Liste_Design[0], name=XML_Liste_Name[0]
        )
        self.fig5 = oad.mass_breakdown_bar_plot(
            XML_Liste_Design[0], name=XML_Liste_Name[0]
        )
        self.fig6 = oad.mass_breakdown_sun_plot(XML_Liste_Design[0])
        i = 1
        while i < len(liste_exo_xml):
            self.fig1 = oad.wing_geometry_plot(
                XML_Liste_Design[i], XML_Liste_Name[i], fig=self.fig1
            )
            self.fig2 = oad.aircraft_geometry_plot(
                XML_Liste_Design[i], XML_Liste_Name[i], fig=self.fig2
            )
            self.fig3 = oad.drag_polar_plot(
                XML_Liste_Design[i], XML_Liste_Name[i], fig=self.fig3
            )
            self.fig4 = self.OAD.payload_range(
                XML_Liste_Design[i],
                CSV_Liste_Design[i],
                name=XML_Liste_Name[i],
                fig=self.fig4,
            )
            self.fig5 = oad.mass_breakdown_bar_plot(
                XML_Liste_Design[i], name=XML_Liste_Name[i], fig=self.fig5
            )
    ...
    # function for deleting the chosen aircraft reference data

    def delete_reference(self, event):
        clear_output()
        display(self.REF_BOX)
        self.delete_ref = self.OAD.Delete_File(
            "File\Reference\Aircraft_reference_data.xml"
        )
    ...
    def reference_aircraft(self, path_to_target):
        ...
        box1 = widgets.HBox(children=[title], layout=layout_title)
        datafile_name = widgets.Dropdown(
            options=self.path_to_file_list,
        ...
        self.Button_S1 = widgets.Button(
            description="Reference data",
            layout=Layout(width="20%", height="50px", border="4px solid black"),
            disabled=True,
            style=dict(button_color="#adadad"),
        )
        self.Button_S1.on_click(self.view_source)
        self.Button_S1.icon = "fa-table"

        # Delete the reference aircraft file already chosen
        Button_S2 = widgets.Button(
            description="Delete",
            layout=Layout(width="20%", height="50px", border="4px solid black"),
            style=dict(button_color="#ff5252"),
        )
        ...
        self.Button_S3 = widgets.Button(
            description="Next",
            layout=Layout(width="20%", height="50px", border="4px solid black"),
            disabled=True,
            style=dict(button_color="#77db5c"),
        )
        self.Button_S3.on_click(self.reference_to_configuration)
        self.Button_S3.icon = "fa-angle-right"
        box3 = widgets.HBox(
            children=[self.Button_S1, Button_S2, self.Button_S3],
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "This is the reference Aircraft Phase. "
                        "The user is expected to select an aircraft from the list.\n"
                        "When it is selected it is stored as the reference.\n"
                        "The user can visualize the data by clicking the button Reference Data,\n"
                        "erase the stored referenced aircraft with  Delete or go to the next step with Next, "
                        "but only once an aircraft is selected.\n"
                    )
        ...
        # --------------------------------------------------------------------------------------------------------------
        box4 = widgets.Box(
            children=[buttonINFO, output, buttonHOME],
            layout=Layout(
    ...
    def configuration_file(self, event):
        ...
        self.module = widgets.SelectMultiple(
            options=liste,
            description="SELECT FAST-OAD MODULES:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="800px", height="150 px"),
            rows=len(liste),
        )
        button = widgets.Button(
            description="SAVE",
            tooltip="SAVE MDA PROBLEM",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        button.on_click(self.Write_Configuration_File)
        button.icon = "fa-floppy-o"
        self.Button_F1 = widgets.Button(
        ...
        self.Button_F3 = widgets.Button(
            description="N2 Diagramm",
            layout=Layout(width="20%", height="50px", border="4px solid black"),
            disabled=True,
            style=dict(button_color="#ebebeb"),
        )
        ...
        self.Button_F4 = widgets.Button(
            description="XDSM Diagramm",
            layout=Layout(width="20%", height="50px", border="4px solid black"),
            disabled=True,
            style=dict(button_color="#ebebeb"),
        )
        ...
        box2 = widgets.HBox(
            children=[self.Button_F1, self.Button_F2, self.Button_F3, self.Button_F4],
            layout=Layout(justify_content="space-between", width="100%"),
        )

        Button_F5 = widgets.Button(
            description="BACK",
            layout=Layout(width="20%", height="45px", border="4px solid black"),
            style=dict(button_color="#3785d8"),
        )
        Button_F5.on_click(self.configuration_to_reference)
        Button_F5.icon = "fa-angle-left"

        self.Button_F6 = widgets.Button(
            description="NEXT",
            layout=Layout(width="20%", height="45px", border="4px solid black"),
            disabled=True,
            style=dict(button_color="#77db5c"),
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "Welcome to the Configuration Phase.\n"
        ...
        # --------------------------------------------------------------------------------------------------------------
        box3 = widgets.HBox(
            children=[Button_F5, buttonHOME, self.Button_F6],
            layout=Layout(justify_content="space-between", width="100%"),
        )
        self.BOX_CONFIG = widgets.VBox(
            children=[box1, self.module, button, box2, box3, box4],
            layout=Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
    ...
    # Function back to the aircraft reference file user
    ...
    # Display the N2 Diagram of the design case
    ...
    def inputs_ui(self):
        ...
        table1 = [
            "VIEW AIRCRAFT DATA",
            "EDIT AIRCRAFT INPUT DATA",
            "SAVE AIRCRAFT  INPUT FILE",
        ]
        ...
        Button_I1 = widgets.Button(
            description=table1[0],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        ...
        Button_I3 = widgets.Button(
            description=table1[2],
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        ...
        Button_I4 = widgets.Button(
            description=table2[0],
            layout=Layout(width="30%", height="40px", border="4px solid #3785d8"),
            style=dict(button_color="#3785d8"),
        )
        Button_I4.on_click(self.input_to_configuration)
        Button_I4.icon = "fa-angle-left"

        Button_I5 = widgets.Button(
            description=table2[1],
            layout=Layout(width="30%", height="40px", border="4px solid  #ff5252"),
            style=dict(button_color="#ff5252"),
        )
        Button_I5.on_click(self.input_aircraft_file)
        Button_I5.icon = "fa-trash-o"

        Button_I6 = widgets.Button(
            description=table2[2],
            layout=Layout(width="30%", height="40px", border="4px solid  #77db5c"),
            style=dict(button_color="#77db5c"),
        )
        ...
        box2 = widgets.HBox(
            children=[Button_I1, Button_I2, Button_I3],
            layout=Layout(justify_content="space-between", width="100%"),
        )
        box3 = widgets.HBox(
            children=[Button_I4, Button_I5, Button_I6],
            layout=Layout(justify_content="space-between", width="100%"),
        )
        box4 = widgets.Box(
            children=[buttonHOME],
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "Welcome to the Aircraft Data Phase.\n"
                        "At this point, with the Reference Aircraft and the Configuration files, "
    ...
    def Inputs_Edit_Ui(self, event=None):
        ...
        # Layout widget
        layout = widgets.Layout(
            width="50%", height="50px", justify_content="space-between"
        )
        style = style = {"description_width": "initial"}
        layout_button = widgets.Layout(
            width="30%", height="50px", border="4px solid black"
        ...
        layout_box = widgets.Layout(
            border="6px solid green", padding="10px", align_items="center", width="100%"
        )
        ...
        T_Button = widgets.Button(
            description="Save", layout=layout_button, style=dict(button_color="#33ffcc")
        )
        T_Button.on_click(self.Save_TLARS)

        self.TLAR_1 = widgets.BoundedFloatText(
            min=100,
            max=400,
            step=1,
            value=self.T_value1,
            disabled=status_T_value1,
            description=T_Table4[0],
            description_tooltip=T_Table3[0],
            style=style,
            layout=layout,
        )
        self.TLAR_2 = widgets.BoundedFloatText(
            min=10,
            max=100,
            step=0.01,
            value=self.T_value2,
            disabled=status_T_value2,
            description=T_Table4[1],
            description_tooltip=T_Table3[1],
            style=style,
            layout=layout,
        )
        self.TLAR_3 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.01,
            value=self.T_value3,
            disabled=status_T_value3,
            description=T_Table4[2],
            description_tooltip=T_Table3[2],
            style=style,
            layout=layout,
        )
        self.TLAR_4 = widgets.BoundedFloatText(
            min=500,
            max=5000,
            step=1,
            value=self.T_value4,
            disabled=status_T_value4,
            description=T_Table4[3],
            description_tooltip=T_Table3[3],
            style=style,
            layout=layout,
        )

        T_box_T = widgets.VBox(
            children=[self.TLAR_1, self.TLAR_2, self.TLAR_3, self.TLAR_4],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.T_box = widgets.VBox(
            children=[T_title, T_box_T, T_Button], layout=layout_box
        )
        ...
        self.CAB_1 = widgets.BoundedFloatText(
            ...
            step=0.001,
            value=self.C_value1,
            disabled=status_C_value1,
            description=C_Table4[0],
            description_tooltip=C_Table3[0],
            style=style,
            layout=layout,
        )
        self.CAB_2 = widgets.BoundedFloatText(
            ...
            step=0.001,
            value=self.C_value2,
            disabled=status_C_value2,
            description=C_Table4[1],
            description_tooltip=C_Table3[1],
            style=style,
            layout=layout,
        )
        self.CAB_3 = widgets.BoundedFloatText(
            ...
            step=1,
            value=self.C_value3,
            disabled=status_C_value3,
            description=C_Table4[2],
            description_tooltip=C_Table3[2],
            style=style,
            layout=layout,
        )
        self.CAB_4 = widgets.BoundedFloatText(
            ...
            step=1,
            value=self.C_value4,
            disabled=status_C_value4,
            description=C_Table4[3],
            description_tooltip=C_Table3[3],
            style=style,
            layout=layout,
        )
        self.CAB_5 = widgets.BoundedFloatText(
            ...
            step=1,
            value=self.C_value5,
            disabled=status_C_value5,
            description=C_Table4[4],
            description_tooltip=C_Table3[4],
            style=style,
            layout=layout,
        )
        self.CAB_6 = widgets.BoundedFloatText(
            ...
            step=0.001,
            value=self.C_value6,
            disabled=status_C_value6,
            description=C_Table4[5],
            description_tooltip=C_Table3[5],
            style=style,
            layout=layout,
        )
        self.CAB_7 = widgets.BoundedFloatText(
            ...
            step=0.001,
            value=self.C_value7,
            disabled=status_C_value7,
            description=C_Table4[6],
            description_tooltip=C_Table3[6],
            style=style,
            layout=layout,
        )
        ...
        self.C_box = widgets.VBox(
            children=[C_title, C_box_C, C_img, C_Button], layout=layout_box
        )
        ...
        try:
            self.W_value3 = self.INPUT["data:geometry:wing:virtual_taper_ratio"].value[
                0
            ]
        ...
        try:
            self.W_value7 = self.INPUT["data:geometry:wing:spar_ratio:front:tip"].value[
                0
            ]
        ...
        try:
            self.W_value8 = self.INPUT["data:geometry:wing:spar_ratio:rear:kink"].value[
                0
            ]
        ...
        try:
            self.W_value9 = self.INPUT["data:geometry:wing:spar_ratio:rear:root"].value[
                0
            ]
        ...
        try:
            self.W_value10 = self.INPUT["data:geometry:wing:spar_ratio:rear:tip"].value[
                0
            ]
        ...
        W_Button = widgets.Button(
            description="Save",
            tooltip="Save data to the aircraft inputs file",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        W_Button.on_click(self.Save_WING)

        self.WING_1 = widgets.BoundedFloatText(
            min=4,
            max=20,
            step=0.01,
            value=self.W_value1,
            disabled=status_W_value1,
            description=W_Table4[0],
            description_tooltip=W_Table3[0],
            style=style,
            layout=layout,
        )
        self.WING_2 = widgets.BoundedFloatText(
            min=15,
            max=60,
            step=0.001,
            value=self.W_value2,
            disabled=status_W_value2,
            description=W_Table4[1],
            description_tooltip=W_Table3[1],
            style=style,
            layout=layout,
        )
        self.WING_3 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value3,
            disabled=status_W_value3,
            description=W_Table4[2],
            description_tooltip=W_Table3[2],
            style=style,
            layout=layout,
        )
        self.WING_4 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value4,
            disabled=status_W_value4,
            description=W_Table4[3],
            description_tooltip=W_Table3[3],
            style=style,
            layout=layout,
        )
        self.WING_5 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value5,
            disabled=status_W_value5,
            description=W_Table4[4],
            description_tooltip=W_Table3[4],
            style=style,
            layout=layout,
        )
        self.WING_6 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value6,
            disabled=status_W_value6,
            description=W_Table4[5],
            description_tooltip=W_Table3[5],
            style=style,
            layout=layout,
        )
        self.WING_7 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value7,
            disabled=status_W_value7,
            description=W_Table4[6],
            description_tooltip=W_Table3[6],
            style=style,
            layout=layout,
        )
        self.WING_8 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value8,
            disabled=status_W_value8,
            description=W_Table4[7],
            description_tooltip=W_Table3[7],
            style=style,
            layout=layout,
        )
        self.WING_9 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value9,
            disabled=status_W_value9,
            description=W_Table4[8],
            description_tooltip=W_Table3[8],
            style=style,
            layout=layout,
        )
        self.WING_10 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.W_value10,
            disabled=status_W_value10,
            description=W_Table4[9],
            description_tooltip=W_Table3[9],
            style=style,
            layout=layout,
        )
        ...
        self.W_box = widgets.VBox(
            children=[W_title, W_box_W, W_img, W_Button], layout=layout_box
        )
        ...
        self.FLAP_1 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.F_value1,
            disabled=status_F_value1,
            description=F_Table4[0],
            description_tooltip=F_Table3[0],
            style=style,
            layout=layout,
        )
        self.FLAP_2 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.F_value2,
            disabled=status_F_value2,
            description=F_Table4[1],
            description_tooltip=F_Table3[1],
            style=style,
            layout=layout,
        )

        F_box_F = widgets.VBox(
            children=[self.FLAP_1, self.FLAP_2],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.F_box = widgets.VBox(
            children=[F_title, F_box_F, F_img, F_Button], layout=layout_box
        )
        ...
        self.SLAT_1 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.S_value1,
            disabled=status_S_value1,
            description=S_Table4[0],
            description_tooltip=S_Table3[0],
            style=style,
            layout=layout,
        )
        self.SLAT_2 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.S_value2,
            disabled=status_S_value2,
            description=S_Table4[1],
            description_tooltip=S_Table3[1],
            style=style,
            layout=layout,
        )

        S_box_S = widgets.VBox(
            children=[self.SLAT_1, self.SLAT_2],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.S_box = widgets.VBox(
            children=[S_title, S_box_S, S_img, S_Button], layout=layout_box
        )

        # HORIZONTAL TAIL UI
        try:
            self.H_value1 = self.INPUT[
        ...
        try:
            self.H_value2 = self.INPUT["data:geometry:horizontal_tail:sweep_25"].value[
                0
            ]
        ...
        self.HT_1 = widgets.BoundedFloatText(
            min=1,
            max=10,
            step=0.001,
            value=self.H_value1,
            disabled=status_H_value1,
            description=H_Table4[0],
            description_tooltip=H_Table3[0],
            style=style,
            layout=layout,
        )
        self.HT_2 = widgets.BoundedFloatText(
            min=10,
            max=50,
            step=0.1,
            value=self.H_value2,
            disabled=status_H_value2,
            description=H_Table4[1],
            description_tooltip=H_Table3[1],
            style=style,
            layout=layout,
        )
        self.HT_3 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.H_value3,
            disabled=status_H_value3,
            description=H_Table4[2],
            description_tooltip=H_Table3[2],
            style=style,
            layout=layout,
        )
        self.HT_4 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.H_value4,
            disabled=status_H_value4,
            description=H_Table4[3],
            description_tooltip=H_Table3[3],
            style=style,
            layout=layout,
        )

        H_box_H = widgets.VBox(
            children=[self.HT_1, self.HT_2, self.HT_3, self.HT_4],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.H_box = widgets.VBox(
            children=[H_title, H_box_H, H_img, H_Button], layout=layout_box
        )

        # VERTICAL TAIL UI
        try:
            self.V_value1 = self.INPUT[
        ...
        try:
            self.V_value3 = self.INPUT["data:geometry:vertical_tail:taper_ratio"].value[
                0
            ]
        ...
        self.VT_1 = widgets.BoundedFloatText(
            min=1,
            max=10,
            step=0.001,
            value=self.V_value1,
            disabled=status_V_value1,
            description=V_Table4[0],
            description_tooltip=V_Table3[0],
            style=style,
            layout=layout,
        )
        self.VT_2 = widgets.BoundedFloatText(
            min=10,
            max=50,
            step=0.1,
            value=self.V_value2,
            disabled=status_V_value2,
            description=V_Table4[1],
            description_tooltip=V_Table3[1],
            style=style,
            layout=layout,
        )
        self.VT_3 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.V_value3,
            disabled=status_V_value3,
            description=V_Table4[2],
            description_tooltip=V_Table3[2],
            style=style,
            layout=layout,
        )
        self.VT_4 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.V_value4,
            disabled=status_V_value4,
            description=V_Table4[3],
            description_tooltip=V_Table3[3],
            style=style,
            layout=layout,
        )

        V_box_V = widgets.VBox(
            children=[self.VT_1, self.VT_2, self.VT_3, self.VT_4],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.V_box = widgets.VBox(
            children=[V_title, V_box_V, V_img, V_Button], layout=layout_box
        )
        ...
        try:
            self.P_value3 = self.INPUT["data:geometry:propulsion:engine:y_ratio"].value[
                0
            ]
        ...
        self.PROP_1 = widgets.BoundedFloatText(
            min=1,
            max=2,
            step=1,
            value=self.P_value1,
            disabled=status_P_value1,
            description=P_Table4[0],
            description_tooltip=P_Table3[0],
            style=style,
            layout=layout,
        )
        self.PROP_2 = widgets.BoundedFloatText(
            min=1,
            max=10,
            step=1,
            value=self.P_value2,
            disabled=status_P_value2,
            description=P_Table4[1],
            description_tooltip=P_Table3[1],
            style=style,
            layout=layout,
        )
        self.PROP_3 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.P_value3,
            disabled=status_P_value3,
            description=P_Table4[2],
            description_tooltip=P_Table3[2],
            style=style,
            layout=layout,
        )

        P_box_P = widgets.VBox(
            children=[self.PROP_1, self.PROP_2, self.PROP_3],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.P_box = widgets.VBox(
            children=[P_title, P_box_P, P_img, P_Button], layout=layout_box
        )
        ...
        We_Button = widgets.Button(
            description="Save", layout=layout_button, style=dict(button_color="#33ffcc")
        )
        We_Button.on_click(self.Save_WEIGHT)
        self.We_1 = widgets.BoundedFloatText(
            min=10000,
            max=60000,
            step=1,
            value=self.We_value1,
            disabled=status_We_value1,
            description=We_Table4[0],
            description_tooltip=We_Table3[0],
            style=style,
            layout=layout,
        )
        self.We_2 = widgets.BoundedFloatText(
            min=10000,
            max=60000,
            step=1,
            value=self.We_value2,
            disabled=status_We_value2,
            description=We_Table4[1],
            description_tooltip=We_Table3[1],
            style=style,
            layout=layout,
        )
        We_box_We = widgets.VBox(
            children=[self.We_1, self.We_2],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.We_box = widgets.VBox(
            children=[We_title, We_box_We, We_img, We_Button], layout=layout_box
        )

        # AERODYNAMICS UI
        try:
            self.A_value1 = self.INPUT[
        ...
        try:
            self.A_value2 = self.INPUT["data:aerodynamics:aircraft:takeoff:mach"].value[
                0
            ]
        ...
        self.AERO_1 = widgets.BoundedFloatText(
            min=0.5,
            max=3,
            step=0.01,
            value=self.A_value1,
            disabled=status_A_value1,
            description=A_Table4[0],
            description_tooltip=A_Table3[0],
            style=style,
            layout=layout,
        )
        self.AERO_2 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.001,
            value=self.A_value2,
            disabled=status_A_value2,
            description=A_Table4[1],
            description_tooltip=A_Table3[1],
            style=style,
            layout=layout,
        )

        A_box_A = widgets.VBox(
            children=[self.AERO_1, self.AERO_2],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.A_box = widgets.VBox(
            children=[A_title, A_box_A, A_img, A_Button], layout=layout_box
        )
        ...
        self.LOAD_1 = widgets.BoundedFloatText(
            min=5,
            max=50,
            step=0.01,
            value=self.L_value1,
            disabled=status_L_value1,
            description=L_Table4[0],
            description_tooltip=L_Table3[0],
            style=style,
            layout=layout,
        )
        self.LOAD_2 = widgets.BoundedFloatText(
            min=100,
            max=1000,
            step=0.1,
            value=self.L_value2,
            disabled=status_L_value2,
            description=L_Table4[1],
            description_tooltip=L_Table3[1],
            style=style,
            layout=layout,
        )
        self.LOAD_3 = widgets.BoundedFloatText(
            min=1000,
            max=100000,
            step=1,
            value=self.L_value3,
            disabled=status_L_value3,
            description=L_Table4[2],
            description_tooltip=L_Table3[2],
            style=style,
            layout=layout,
        )
        self.LOAD_4 = widgets.BoundedFloatText(
            min=5,
            max=50,
            step=0.01,
            value=self.L_value4,
            disabled=status_L_value4,
            description=L_Table4[3],
            description_tooltip=L_Table3[3],
            style=style,
            layout=layout,
        )
        self.LOAD_5 = widgets.BoundedFloatText(
            min=100,
            max=1000,
            step=0.001,
            value=self.L_value5,
            disabled=status_L_value5,
            description=L_Table4[4],
            description_tooltip=L_Table3[4],
            style=style,
            layout=layout,
        )
        self.LOAD_6 = widgets.BoundedFloatText(
            min=1000,
            max=100000,
            step=1,
            value=self.L_value6,
            disabled=status_L_value6,
            description=L_Table4[5],
            description_tooltip=L_Table3[5],
            style=style,
            layout=layout,
        )

        L_box_L = widgets.VBox(
            children=[
                self.LOAD_1,
                self.LOAD_2,
                self.LOAD_3,
        ...
        self.L_box = widgets.VBox(
            children=[L_title, L_box_L, L_img, L_Button], layout=layout_box
        )
        ...
        # MTOW MISSION
        try:
            self.MTOW_value1 = self.INPUT[
                "data:mission:MTOW_mission:diversion:distance"
            ].value[0]
        ...
        try:
            self.MTOW_value2 = self.INPUT[
                "data:mission:MTOW_mission:holding:duration"
            ].value[0]
        ...
        try:
            self.MTOW_value3 = self.INPUT[
                "data:mission:MTOW_mission:main_route:range"
            ].value[0]
        ...
        try:
            self.MTOW_value4 = self.INPUT["data:mission:MTOW_mission:takeoff:V2"].value[
                0
            ]
        ...
        try:
            self.MTOW_value5 = self.INPUT[
                "data:mission:MTOW_mission:takeoff:fuel"
            ].value[0]
        ...
        MTOW_Button = widgets.Button(
            description="Save", layout=layout_button, style=dict(button_color="#33ffcc")
        )
        MTOW_Button.on_click(self.Save_MTOW)

        self.MTOW_1 = widgets.BoundedFloatText(
            min=50,
            max=500,
            step=1,
            value=self.MTOW_value1,
            disabled=status_MTOW_value1,
            description=MTOW_Table4[0],
            description_tooltip=MTOW_Table3[0],
            style=style,
            layout=layout,
        )
        self.MTOW_2 = widgets.BoundedFloatText(
            min=10,
            max=100,
            step=1,
            value=self.MTOW_value2,
            disabled=status_MTOW_value2,
            description=MTOW_Table4[1],
            description_tooltip=MTOW_Table3[1],
            style=style,
            layout=layout,
        )
        self.MTOW_3 = widgets.BoundedFloatText(
            min=1000,
            max=10000,
            step=1,
            value=self.MTOW_value3,
            disabled=status_MTOW_value3,
            description=MTOW_Table4[2],
            description_tooltip=MTOW_Table3[2],
            style=style,
            layout=layout,
        )
        self.MTOW_4 = widgets.BoundedFloatText(
            min=10,
            max=200,
            step=0.1,
            value=self.MTOW_value4,
            disabled=status_MTOW_value4,
            description=MTOW_Table4[3],
            description_tooltip=MTOW_Table3[3],
            style=style,
            layout=layout,
        )
        self.MTOW_5 = widgets.BoundedFloatText(
            min=10,
            max=200,
            step=0.1,
            value=self.MTOW_value5,
            disabled=status_MTOW_value5,
            description=MTOW_Table4[4],
            description_tooltip=MTOW_Table3[4],
            style=style,
            layout=layout,
        )

        MTOW_box_MTOW = widgets.VBox(
            children=[self.MTOW_1, self.MTOW_2, self.MTOW_3, self.MTOW_4, self.MTOW_5],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.MTOW_box = widgets.VBox(
            children=[MTOW_title, MTOW_box_MTOW, MTOW_img, MTOW_Button],
            layout=layout_box,
        )

        # SIZING MISSION
        try:
            self.Size_value1 = self.INPUT[
        ...
        Size_Button = widgets.Button(
            description="Save", layout=layout_button, style=dict(button_color="#33ffcc")
        )
        Size_Button.on_click(self.Save_SIZE)
        self.Size_1 = widgets.BoundedFloatText(
            min=10,
            max=60,
            step=0.1,
            value=self.Size_value1,
            disabled=status_Size_value1,
            description=Size_Table4[0],
            description_tooltip=Size_Table3[0],
            style=style,
            layout=layout,
        )
        self.Size_2 = widgets.BoundedFloatText(
            min=10,
            max=60,
            step=0.1,
            value=self.Size_value2,
            disabled=status_Size_value2,
            description=Size_Table4[1],
            description_tooltip=Size_Table3[1],
            style=style,
            layout=layout,
        )
        self.Size_3 = widgets.BoundedFloatText(
            min=10,
            max=60,
            step=0.1,
            value=self.Size_value3,
            disabled=status_Size_value3,
            description=Size_Table4[2],
            description_tooltip=Size_Table3[2],
            style=style,
            layout=layout,
        )
        self.Size_4 = widgets.BoundedFloatText(
            min=10,
            max=60,
            step=0.1,
            value=self.Size_value4,
            disabled=status_Size_value4,
            description=Size_Table4[3],
            description_tooltip=Size_Table3[3],
            style=style,
            layout=layout,
        )
        self.Size_5 = widgets.BoundedFloatText(
            min=10000,
            max=60000,
            step=100,
            value=self.Size_value5,
            disabled=status_Size_value5,
            description=Size_Table4[4],
            description_tooltip=Size_Table3[4],
            style=style,
            layout=layout,
        )
        Size_box_Size = widgets.VBox(
            children=[self.Size_1, self.Size_2, self.Size_3, self.Size_4, self.Size_5],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.Size_box = widgets.VBox(
            children=[Size_title, Size_box_Size, Size_img, Size_Button],
            layout=layout_box,
        )
        ...
        self.PR_1 = widgets.BoundedFloatText(
            min=5000,
            max=500000,
            step=1,
            value=self.PR_value1,
            disabled=status_PR_value1,
            description=PR_Table4[0],
            description_tooltip=PR_Table3[0],
            style=style,
            layout=layout,
        )
        self.PR_2 = widgets.BoundedFloatText(
            min=1,
            max=20,
            step=1,
            value=self.PR_value2,
            disabled=status_PR_value2,
            description=PR_Table4[1],
            description_tooltip=PR_Table3[1],
            style=style,
            layout=layout,
        )
        self.PR_3 = widgets.BoundedFloatText(
            min=1000,
            max=20000,
            step=0.1,
            value=self.PR_value3,
            disabled=status_PR_value3,
            description=PR_Table4[2],
            description_tooltip=PR_Table3[2],
            style=style,
            layout=layout,
        )
        self.PR_4 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.1,
            value=self.PR_value4,
            disabled=status_PR_value4,
            description=PR_Table4[3],
            description_tooltip=PR_Table3[3],
            style=style,
            layout=layout,
        )
        self.PR_5 = widgets.BoundedFloatText(
            min=1,
            max=100,
            step=0.1,
            value=self.PR_value5,
            disabled=status_PR_value5,
            description=PR_Table4[4],
            description_tooltip=PR_Table3[4],
            style=style,
            layout=layout,
        )
        self.PR_6 = widgets.BoundedFloatText(
            min=500,
            max=3000,
            step=1,
            value=self.PR_value6,
            disabled=status_PR_value6,
            description=PR_Table4[5],
            description_tooltip=PR_Table3[5],
            style=style,
            layout=layout,
        )
        PR_box_PR = widgets.VBox(
            children=[self.PR_1, self.PR_2, self.PR_3, self.PR_4, self.PR_5, self.PR_6],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.PR_box = widgets.VBox(
            children=[PR_title, PR_box_PR, PR_img, PR_Button], layout=layout_box
        )
    ...
    def Save_FUSELAGE(self, event):
        ...
        try:
            self.INPUT[
                "data:geometry:cabin:containers:count_by_row"
            ].value = self.CAB_3.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:cabin:crew_count:technical"
            ].value = self.CAB_4.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:cabin:seats:economical:count_by_row"
            ].value = self.CAB_5.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:cabin:seats:economical:length"
            ].value = self.CAB_6.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:cabin:seats:economical:width"
            ].value = self.CAB_7.value
        except:
            pass
        self.INPUT.save()
    ...
    def Save_WING(self, event):
        ...
        try:
            ...
            pass
        try:
            self.INPUT["data:geometry:wing:virtual_taper_ratio"].value = (
                1.5 * self.WING_3.value
            )
        except:
            pass
        try:
    ...
    def Save_HT(self, event):
        ...
        try:
            self.INPUT[
                "data:geometry:horizontal_tail:taper_ratio"
            ].value = self.HT_3.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:horizontal_tail:thickness_ratio"
            ].value = self.HT_4.value
        except:
            pass
    ...
    def Save_VT(self, event):
        ...
        try:
            ...
            ].value = self.VT_3.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:vertical_tail:thickness_ratio"
            ].value = self.VT_4.value
        except:
            pass
    ...
    def Save_P(self, event):
        ...
        try:
            ...
            ].value = self.PROP_2.value
        except:
            pass
        try:
            self.INPUT[
                "data:geometry:propulsion:engine:y_ratio"
            ].value = self.PROP_3.value
        except:
            pass
    ...
    def Save_AERO(self, event):
        try:
            self.INPUT[
                "data:aerodynamics:aircraft:landing:CL_max_clean_2D"
            ].value = self.AERO_1.value
        except:
            pass
        try:
            self.INPUT[
                "data:aerodynamics:aircraft:takeoff:mach"
            ].value = self.AERO_2.value
        except:
            pass
    ...
    def Save_MTOW(self, event):
        try:
            self.INPUT[
                "data:mission:MTOW_mission:diversion:distance"
            ].value = self.MTOW_1.value
        except:
            pass
        try:
            self.INPUT[
                "data:mission:MTOW_mission:holding:duration"
            ].value = self.MTOW_2.value
        except:
            pass
        try:
            self.INPUT[
                "data:mission:MTOW_mission:main_route:range"
            ].value = self.MTOW_3.value
        except:
            pass
        try:
    ...
    def Save_SIZE(self, event):
        try:
            self.INPUT[
                "data:mission:sizing:landing:flap_angle"
            ].value = self.Size_1.value
        except:
            pass
        try:
            self.INPUT[
                "data:mission:sizing:landing:slat_angle"
            ].value = self.Size_2.value
        except:
            pass
        try:
            self.INPUT[
                "data:mission:sizing:takeoff:flap_angle"
            ].value = self.Size_3.value
        except:
            pass
        try:
            self.INPUT[
                "data:mission:sizing:takeoff:slat_angle"
            ].value = self.Size_4.value
        except:
            pass
        try:
            self.INPUT[
                "data:mission:sizing:main_route:cruise:altitude"
            ].value = self.Size_5.value
        except:
            pass
    ...
    def Save_PR(self, event):
        ...
        try:
            self.INPUT[
                "data:propulsion:rubber_engine:bypass_ratio"
            ].value = self.PR_2.value
        except:
            pass
        try:
            self.INPUT[
                "data:propulsion:rubber_engine:design_altitude"
            ].value = self.PR_3.value
        except:
            pass
        try:
            self.INPUT[
                "data:propulsion:rubber_engine:maximum_mach"
            ].value = self.PR_4.value
        except:
            pass
        try:
            self.INPUT[
                "data:propulsion:rubber_engine:overall_pressure_ratio"
            ].value = self.PR_5.value
        except:
            pass
        try:
            self.INPUT[
                "data:propulsion:rubber_engine:turbine_inlet_temperature"
            ].value = self.PR_6.value
        except:
            pass
    ...
    def Save_In_F_UI(self, event):
        ...
        display(self.BOX_INPUT)
        layout = widgets.Layout(
            width="50%", height="40px", justify_content="space-between"
        )
        style = style = {"description_width": "initial"}
        layout_button = widgets.Layout(
            width="30%", height="50px", border="4px solid black"
        ...
        SI_Button = widgets.Button(
            description="SAVE",
            tooltip="Save the  input file",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        SI_Button.on_click(self.Save_INPUT_FILE)

        SI_box_SI = widgets.VBox(
            children=[self.IN_NAME],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.SI_box = widgets.VBox(
            children=[SI_Title, self.IN_NAME, SI_Button], layout=layout_box
        )
        display(self.SI_box)
    ...
    def input_aircraft_file(self, event):
        ...
        box1 = widgets.HBox(children=[title], layout=layout_title)
        self.input_file_name = widgets.Dropdown(
            options=self.path_to_file_list,
            description="Choose your file:",
            disabled=False,
            style={"description_width": "initial"},
    ...
    def MDA_UI(self, event):
        ...
        layout_button1 = widgets.Layout(
            width="30%", height="60px", border="4px solid black"
        )
        layout_button2 = widgets.Layout(
            width="30%", height="40px", border="4px solid black"
        )
        layout_box1 = widgets.Layout(justify_content="space-between", width="100%")
        layout_box2 = widgets.Layout(
            border="6px solid black", padding="10px", align_items="center", width="100%"
        )

        title = widgets.HTML(value=" <b>MDA ANALYSIS </b>")

        Button_MD11 = widgets.Button(
            description=table1[0],
            tooltip="Run the MDA Design Problem",
            layout=layout_button1,
            style=dict(button_color="#ebebeb"),
        )
        Button_MD11.on_click(self.RUN_MDA)

        self.Button_MD12 = widgets.Button(
            description=table1[1],
            layout=layout_button1,
            disabled=True,
            style=dict(button_color="#ebebeb"),
        ...
        box1 = widgets.HBox(
            children=[Button_MD11, self.Button_MD12, Button_MD13], layout=layout_box1
        )

        self.Button_MD21 = widgets.Button(
            description=table2[0],
            tooltip="view the outputs of the mda design problem",
            disabled=True,
            layout=layout_button2,
            style=dict(button_color="#ffccb3"),
        )
        self.Button_MD21.on_click(self.View_Ouput_Data)
        self.Button_MD21.icon = "fa-table"

        self.Button_MD22 = widgets.Button(
            description=table2[1],
            layout=layout_button2,
            disabled=True,
            style=dict(button_color="#00ffbf"),
        )
        self.Button_MD22.on_click(self.Save_OUT_F_UI)
        self.Button_MD22.icon = "fa-floppy-o"

        Button_MD23 = widgets.Button(
            description=table2[2],
            layout=layout_button2,
            style=dict(button_color="#ff5252"),
        )
        ...
        box2 = widgets.HBox(
            children=[self.Button_MD21, self.Button_MD22, Button_MD23],
            layout=layout_box1,
        )

        self.Button_MD31 = widgets.Button(
            description=table3[0],
            layout=layout_button2,
            disabled=True,
            style=dict(button_color="#3785d8"),
        )
        ...
        Button_MD32 = widgets.Button(
            description=table3[1],
            layout=layout_button2,
            style=dict(button_color="#77db5c"),
        )
        ...
        box3 = widgets.HBox(
            children=[self.Button_MD31, buttonHOME, Button_MD32], layout=layout_box1
        )
        ...
        # --------------------------------------------------------------------------------------------------------------
        self.BOX_MDA = widgets.VBox(
            children=[title, box1, box2, box3, box4], layout=layout_box2
        )
    ...
    def RUN_MDA(self, event):
        ...
        # If the modules list contain the module PERFORMANCE then...
        # ...the MISSION ANALYSIS  button is enabled, if not, it remains disabled.
        # Also the button MDA OUTPUTS is only enabled after the analysis is run, otherwise there is no file to show.
        # Also the button SAVE AIRCRAFT DATA is only enabled after the analysis is run,
        # ...otherwise there is no file to log
    ...
    def Save_OUT_F_UI(self, event):
        ...
        self.OUT_NAME = widgets.Text(
            placeholder="Type the files name",
        ...
        SO_Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE OUTPUTS",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        SO_Button.on_click(self.Save_OUTPUT_FILE)
        SO_box_SI = widgets.VBox(
            children=[self.OUT_NAME],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.SO_box = widgets.VBox(
            children=[SO_Title, self.OUT_NAME, SO_Button], layout=layout_box
        )
        display(self.SO_box)
    ...
    def Mission_Analysis_UI(self, event):
        ...
        self.OPM_value2 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:diversion:distance"
        ].value[0]
        self.OPM_value3 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:holding:duration"
        ].value[0]
        self.OPM_value4 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:main_route:range"
        ].value[0]
        self.OPM_value5 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:takeoff:V2"
        ].value[0]
        self.OPM_value6 = (
            self.OUTPUT_DATA["data:mission:MTOW_mission:takeoff:safety_altitude"].value[
                0
            ]
            * 0.3048
        )
        self.OPM_value7 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:takeoff:fuel"
        ].value[0]
        self.OPM_value8 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:taxi_in:duration"
        ].value[0]
        self.OPM_value9 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:taxi_out:duration"
        ].value[0]
        self.OPM_value10 = self.OUTPUT_DATA[
            "data:mission:MTOW_mission:taxi_out:thrust_rate"
        ].value[0]
        ...
        self.OPM_1 = widgets.BoundedFloatText(
            min=10000,
            max=30000,
            step=1,
            value=self.OPM_value1,
            disabled=False,
            description=OPM_Table4[0],
            description_tooltip=OPM_Table3[0],
            style=style,
            layout=layout,
        )
        self.OPM_2 = widgets.BoundedFloatText(
            min=100,
            max=400,
            step=1,
            value=self.OPM_value2,
            disabled=False,
            description=OPM_Table4[1],
            description_tooltip=OPM_Table3[1],
            style=style,
            layout=layout,
        )

        self.OPM_3 = widgets.BoundedFloatText(
            min=10,
            max=100,
            step=1,
            value=self.OPM_value3,
            disabled=False,
            description=OPM_Table4[2],
            description_tooltip=OPM_Table3[1],
            style=style,
            layout=layout,
        )
        self.OPM_4 = widgets.BoundedFloatText(
            min=1000,
            max=7000,
            step=1,
            value=self.OPM_value4,
            disabled=False,
            description=OPM_Table4[3],
            description_tooltip=OPM_Table3[3],
            style=style,
            layout=layout,
        )
        self.OPM_5 = widgets.BoundedFloatText(
            min=10,
            max=200,
            step=0.1,
            value=self.OPM_value5,
            disabled=False,
            description=OPM_Table4[4],
            description_tooltip=OPM_Table3[4],
            style=style,
            layout=layout,
        )
        self.OPM_6 = widgets.BoundedFloatText(
            min=0,
            max=20,
            step=1,
            value=self.OPM_value6,
            disabled=False,
            description=OPM_Table4[5],
            description_tooltip=OPM_Table3[5],
            style=style,
            layout=layout,
        )
        self.OPM_7 = widgets.BoundedFloatText(
            min=10,
            max=200,
            step=0.1,
            value=self.OPM_value7,
            disabled=False,
            description=OPM_Table4[6],
            description_tooltip=OPM_Table3[6],
            style=style,
            layout=layout,
        )
        self.OPM_8 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=self.OPM_value8,
            disabled=False,
            description=OPM_Table4[7],
            description_tooltip=OPM_Table3[7],
            style=style,
            layout=layout,
        )
        self.OPM_9 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=self.OPM_value9,
            disabled=False,
            description=OPM_Table4[8],
            description_tooltip=OPM_Table3[8],
            style=style,
            layout=layout,
        )
        self.OPM_10 = widgets.BoundedFloatText(
            min=0,
            max=1,
            step=0.01,
            value=self.OPM_value10,
            disabled=False,
            description=OPM_Table4[9],
            description_tooltip=OPM_Table3[9],
            style=style,
            layout=layout,
        )
        OPM_box1 = widgets.VBox(
            children=[
                self.OPM_1,
                self.OPM_2,
                self.OPM_3,
        ...
        OPM_box2 = widgets.HBox(
            children=[OPM_Button1, OPM_Button2, OPM_Button3], layout=layout_box1
        )
        self.OPM_box = widgets.VBox(
            children=[OPM_title, OPM_box1, OPM_box2], layout=layout_box
        )
    ...
    def Run_Mission_Aanlysis(self, event):
        ...
        self.Liste_File = self.OAD.MISSION_ANALYSIS(
            config_file_name, source_file_name, path_config, path_source
        )
        ...
        self.OP_INPUT_DATA["data:mission:op_mission:diversion:distance"].value = (
            1852 * self.OPM_2.value
        )
        self.OP_INPUT_DATA[
            "data:mission:op_mission:holding:duration"
        ].value = self.OPM_3.value
        self.OP_INPUT_DATA["data:mission:op_mission:main_route:range"].value = (
            1852 * self.OPM_4.value
        )
        self.OP_INPUT_DATA[
            "data:mission:op_mission:takeoff:V2"
        ].value = self.OPM_5.value
        self.OP_INPUT_DATA[
            "data:mission:op_mission:takeoff:safety_altitude"
        ].value = self.OPM_6.value
        self.OP_INPUT_DATA[
            "data:mission:op_mission:takeoff:fuel"
        ].value = self.OPM_7.value
        self.OP_INPUT_DATA[
            "data:mission:op_mission:taxi_in:duration"
        ].value = self.OPM_8.value
        self.OP_INPUT_DATA[
            "data:mission:op_mission:taxi_out:duration"
        ].value = self.OPM_9.value
        self.OP_INPUT_DATA[
            "data:mission:op_mission:taxi_out:thrust_rate"
        ].value = self.OPM_10.value
    ...
    def Save_OP_OUT_F_UI(self, event):
        ...
        OP_box_OP = widgets.VBox(
            children=[self.OP_OUT_NAME],
            layout=widgets.Layout(
                border="3px solid black",
                align_items="center",
                padding="10px",
        ...
        self.OP_box = widgets.VBox(
            children=[OP_Title, OP_box_OP, OP_Button], layout=layout_box
        )
        display(self.OP_box)
    ...
    def Save_OP_OUTPUT_FILE(self, event):
        ...
        print(
            str(self.OP_OUT_NAME.value)
            + " OPERATIONAL  MISSION FILES SAVED IN THE MISSION_FILE FOLDER "
        )
        print("-------------------------------------------")
    ...
    def Output_aircraft_file(self, event):
        ...
        box1 = widgets.HBox(children=[title], layout=layout_title)
        self.output_file_name = widgets.Dropdown(
            options=path_to_file_list,
            description="Choose your file:",
            disabled=False,
            style={"description_width": "initial"},
        )
    ...
    def delete_output_file(self, change):
        ...
        print(
            ...
            + str(change.new)
            + " "
            + "file from the OUTPUT_FILE FOLD"
        )
        print("------------------------------------------------")
    ...
    # THE PRINCIPAL AIRCRAFT ANALYSIS USER INTERFACE

    def POST_PROCESSING_UI(self, event):
        clear_output()
        layout = widgets.Layout(
            width="60%", height="40px", justify_content="space-between"
        )
        style = style = {"description_width": "initial"}
        layout_button = widgets.Layout(
            width="30%", height="50px", border="4px solid black"
        ...
        self.RES_choice = widgets.Dropdown(
            description="CHOOSE THE ANALYSIS TOOL",
            options=RES_options,
            style=style,
            layout=layout,
        )
        RES_Button1 = widgets.Button(
            description="SAVE",
            tooltip=" CONFIRM THE  CHOOSEN ANALYSIS TOOL",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        ...
        RES_Button2 = widgets.Button(
            description="BACK", layout=layout_button, style=dict(button_color="#3785d8")
        )
        RES_Button3 = widgets.Button(
            description="NEXT", layout=layout_button, style=dict(button_color="#77db5c")
        )
        ...
        # ---------------------------------------------------------------------------------------------------------------
        box = widgets.HBox(
            children=[RES_Button2, RES_Button1, RES_Button3, box5],
            layout=widgets.Layout(
                justify_content="space-between", width="100%", padding="10 px"
            ),
        )
        self.RES_box = widgets.VBox(
            children=[title, self.RES_choice, box, box4], layout=layout_box
        )
    ...
    # FUNCTION: FROM THE ANALYSIS PHASE TO MDA  PHASE
    ...
    def PLOT_UI(self, event):
        ...
        self.output_file_geo = widgets.SelectMultiple(
            options=path_to_file_list,
            description="CHOOSE THE AIRCRAFT FILES:",
            disabled=False,
            style={"description_width": "initial"},
        ...
        self.geo_plot_choice = widgets.Select(
            options=PLOT_OPTION,
            description="CHOOSE WHICH GEOMETRY TO PLOT:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(PLOT_OPTION),
        )
        GEO_Button = widgets.Button(
            description="PLOT",
            tooltip="PLOT THE GEOMETRY OF THE SELECTED AIRCRAFT",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        GEO_Button.on_click(self.Geometry_Plot)
        self.GEO_UI_BOX = widgets.VBox(
            children=[GEO_box1, GEO_box2, self.geo_plot_choice, GEO_Button],
            layout=widgets.Layout(
        ...
        self.output_file_aero = widgets.SelectMultiple(
            options=path_to_file_list,
            description="CHOOSE THE AIRCRAFT TO ANALYZE:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(path_to_file_list),
        ...
        AERO_Button = widgets.Button(
            description="PLOT",
            tooltip="PLOT THE DRAG POLAR OF THE SELECTED AIRCRAFT",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        AERO_Button.on_click(self.Aerodynamic_Plot)
        self.AERO_UI_BOX = widgets.VBox(
            children=[AERO_box1, AERO_box2, AERO_Button],
            layout=widgets.Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
        ...
        self.output_file_mass = widgets.SelectMultiple(
            options=path_to_file_list,
            description="CHOOSE THE AIRCRAFT TO ANALYZE:",
            disabled=False,
            style={"description_width": "initial"},
        ...
        self.mass_plot_choice = widgets.Select(
            options=Strategy_Option,
            description="CHOOSE THE PLOT STRATEGY:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(Strategy_Option),
        )
        MASS_box2 = widgets.HBox(children=[self.output_file_mass])
        MASS_box3 = widgets.HBox(children=[self.mass_plot_choice])
        MASS_Button = widgets.Button(
            description="PLOT",
            tooltip="PLOT THE MASS BREAKDOWN THE SELECTED AIRCRAFT",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        MASS_Button.on_click(self.Mass_Plot)

        self.MASS_UI_BOX = widgets.VBox(
            children=[MASS_box1, MASS_box2, MASS_box3, MASS_Button],
            layout=widgets.Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
        ...
        self.output_file_miss = widgets.SelectMultiple(
            options=path_to_file_list,
            description="CHOOSE THE MISSION TO ANALYZE:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(path_to_file_list),
        ...
        MISS_Button = widgets.Button(
            description="PLOT",
            tooltip="PLOT THE MISSION  OF THE SELECTED AIRCRAFT",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        MISS_Button.on_click(self.Mission_Plot)

        self.MISS_UI_BOX = widgets.VBox(
            children=[MISS_box1, MISS_box2, MISS_Button],
            layout=widgets.Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
        ...
        for i in range(0, len(temp)):
            if temp[i][-3:] == "xml":
                path_to_file_list.append(temp[i])
        PAY_title = widgets.HTML(value=" <b>PAYLOAD/RANGE DIAGRAM </b>")

        PAY_box1 = widgets.HBox(children=[PAY_title], layout=layout_title)
        self.output_file_pay = widgets.SelectMultiple(
            options=path_to_file_list,
            description="CHOOSE THE AIRCRAFT TO ANALYZE:",
            disabled=False,
            style={"description_width": "initial"},
        ...
        self.PAY_UI_BOX = widgets.VBox(
            children=[PAY_box1, PAY_box2, PAY_Button],
            layout=widgets.Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
        ...
        self.output_file_MODEL3D = widgets.SelectMultiple(
            options=path_to_file_list,
            description="CHOOSE THE AIRCRAFT TO ANALYZE (only ONE):",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(path_to_file_list),
        ...
        MODEL3D_Button = widgets.Button(
            description="PLOT",
            tooltip="PLOT the 3d model of the aircraft",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        MODEL3D_Button.on_click(self.Model3d_Plot)

        self.MODEL3D_UI_BOX = widgets.VBox(
            children=[MODEL3D_box1, MODEL3D_box2, MODEL3D_Button],
            layout=widgets.Layout(
                border="6px solid black",
                padding="10px",
                align_items="center",
        ...
        # SHOW THE PAYLOAD RANGE DIAGRAM PLOT  UI
    ...
    def PAYLOAD_RANGE_PLOT(self, event):
        ...
        fig = self.OAD.payload_range(
            FILE_PATH[0], MISSION_PATH[0], name=mission_name[0]
        )
        k = 1
        while k < len(FILE_PATH):
            fig = self.OAD.payload_range(
                FILE_PATH[k], MISSION_PATH[k], name=mission_name[k], fig=fig
            )
            k = k + 1
    ...
    def OPT_DESIGN(self, event):
        ...
        title = widgets.HTML(value=" <b>OPTIMIZATION</b>")
        self.AC_Opt = widgets.Select(
            options=path_to_file_list,
            description="CHOOSE THE AIRCRAFT TO OPTIMIZE:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(path_to_file_list),
        )
        AC_Button = widgets.Button(
            description="SAVE THE CHOICE",
            tooltip="SAVE THE CHOSEN AIRCRAFT ",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "Welcome to the Optimization Phase.\n"
        ...
        # ---------------------------------------------------------------------------------------------------------------
        self.AC_BOX = widgets.VBox(
            children=[title, self.AC_Opt, AC_Button, box5, box4], layout=layout_box
        )
        display(self.AC_BOX)
    ...
    def OPT_PROBLEM_UI(self, event):
        ...
        layout = widgets.Layout(
            width="30%", height="40px", justify_content="space-between"
        )
        style = style = {"description_width": "initial"}
        layout_button = widgets.Layout(
            width="30%", height="50px", border="4px solid black"
        )
        layout_V = widgets.Layout(
            border="4px solid black", padding="10px", align_items="center", width="100%"
        )
        layout_box = widgets.Layout(
            border="6px solid black", padding="10px", align_items="center", width="100%"
        )
        ...
        self.DES_W2 = widgets.Dropdown(
            options=self.liste_in,
            value=self.liste_in[0],
            description="DESIGN VARIABLE:",
            disabled=False,
            style=style,
        )
        self.DES_LOWER = widgets.BoundedFloatText(
            min=0,
            max=10000000,
            step=0.001,
            value=0,
            ...
            description_tooltip="ENTER THE MINIMUM VALUE OF THE DESIGN VARIABLE",
            style=style,
            layout=layout,
        )
        self.DES_UPPER = widgets.BoundedFloatText(
            min=0,
            max=10000000,
            step=0.001,
            value=0,
            ...
            description_tooltip="ENTER THE MAXIMUM VALUE OF THE DESIGN VARIABLE",
            style=style,
            layout=layout,
        )
        DES_box1 = widgets.HBox(children=[self.DES_W1, self.DES_W2], layout=layout_H)
        DES_box2 = widgets.HBox(
            children=[self.DES_LOWER, self.DES_UPPER], layout=layout_H
        )
        DES_BOX = widgets.VBox(
            children=[DES_Title, DES_box1, DES_box2], layout=layout_V
        )
        ...
        self.CONS_W1 = widgets.Dropdown(
            options=CONS_option1,
            value=CONS_option1[0],
            description="VARIABLE TYPE:",
            disabled=False,
            style=style,
        )
        self.CONS_W1.observe(self.OPT_CONS_CHANGE, names="value")
        self.CONS_W2 = widgets.Dropdown(
            options=self.liste_out,
            value=self.liste_out[0],
            description="CONSTRAINT VARIABLE:",
            disabled=False,
            style=style,
        )
        self.CONS_VAL = widgets.BoundedFloatText(
            min=0,
            max=10000000,
            step=0.001,
            value=0,
            disabled=False,
            description=" VALUE",
            description_tooltip="ENTER THE CONSTRAINT VALUE",
            style=style,
            layout=layout,
        )
        self.CONS_LU = widgets.Dropdown(
            options=["lower", "upper"],
            value="lower",
            description="LOWER/UPPER CONSTRAINT:",
            disabled=False,
            style=style,
        )
        CONS_box1 = widgets.HBox(children=[self.CONS_W1, self.CONS_W2], layout=layout_H)
        CONS_box2 = widgets.HBox(
            children=[self.CONS_LU, self.CONS_VAL], layout=layout_H
        )
        CONS_BOX = widgets.VBox(
            children=[CONS_Title, CONS_box1, CONS_box2], layout=layout_V
        )
        ...
        OPT_Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE OPTIMIZATION PROBLEM",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
            ...
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        ...
                        "Choose and give a value to the Design and Constraint Variables "
                        "and finally define the Objective \n"
                    )
        ...
        # ---------------------------------------------------------------------------------------------------------------
        self.OPT_BOX = widgets.VBox(
            children=[OPT_Title, DES_BOX, CONS_BOX, OBJ_BOX, OPT_Button, box5, box4],
            layout=layout_box,
        )
    ...
    def Opt_Problem(self, event):
        ...
        data = {
            "optimization": {
                "design_variables": [
                    {"name": des_name, "lower": des_low, "upper": des_up}
                ],
                "constraints": [{"name": cons_name, cons_up_low: cons_val}],
        ...
        # NEXT OPTIMIZATION USER INTERFACE
        clear_output()
        ...
        OPT_Button1 = widgets.Button(
            description="OPTIMIZATION PROBLEM",
            tooltip="VIEW THE OPTIMIZATION PROBLEM",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        OPT_Button1.on_click(self.OPt_View)

        OPT_Button2 = widgets.Button(
            description="RUN OPTIMIZATION",
            tooltip="RUN THE OPTIMIZATION PROBLEM",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        OPT_Button2.on_click(self.Run_Opt_Problem)

        OPT_Button3 = widgets.Button(
            description="OPTIMIZATION RESULTS",
            tooltip="VIEW THE OPTIMIZATION RESULTS",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        OPT_Button3.on_click(self.Opt_Result)

        OPT_Button4 = widgets.Button(
            description="OPTIMIZED AIRCRAFT",
            tooltip="VIEW ALL THE OPTIMIZED AIRCRAFT DATA",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        OPT_Button4.on_click(self.View_Opt_Ouput_Data)

        OPT_Button5 = widgets.Button(
            description="SAVE THE AIRCRAFT DATA ",
            tooltip="SAVE THE DATA OF THE OPTIMIZED AIRCRAFT",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        OPT_Button5.on_click(self.Save_OPT_F_UI)
        OPT_Button6 = widgets.Button(
            description="AIRCRAFT ANALYSIS",
            tooltip="ANALYSE THE OPTIMIZED AIRCRAFT ",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        OPT_Button6.on_click(self.Opt_Analysis)
        OPT_Button7 = widgets.Button(
            description="CLOSE",
            tooltip="CLOSE THE OPTIMIZATION WINDOW",
            layout=layout_button,
            style=dict(button_color="#FF0800"),
        )
        ...
        # ---------------------------------------------------------------------------------------------------------------
        self.OPT_BOX = widgets.VBox(
            children=[title, box1, box2, box3, OPT_Button7, box5, box4],
            layout=layout_box,
        )
        display(self.OPT_BOX)
    ...
    def Save_OPT_F_UI(self, event):
        ...
        self.SOPT_box = widgets.VBox(
            children=[SOPT_Title, self.OPT_NAME, SOPT_Button], layout=layout_box
        )
    ...
    # FUNCTION: OPTIMIZATION PHASE TO THE PRINCIPAL MENU
    ...
    def PARAMETRIC_UI1(self, event):
        ...
        title = widgets.HTML(value=" <b>INCREMENTAL DEVELOPMENT </b>")
        self.AC = widgets.Select(
            options=path_to_file_list,
            description="AIRCRAFT SELECTION:",
            disabled=False,
            style={"description_width": "initial"},
            layout=widgets.Layout(width="500px", height="150 px"),
            rows=len(path_to_file_list),
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE SELECTED AIRCRAFT",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        ...
        self.ID1_box = widgets.VBox(
            children=[title, self.AC, Button, buttonHOME], layout=layout_box
        )
    ...
    def PARAMETRIC_UI2(self, event):
        ...
        try:
            ...
            print(
                "------------NO MISSION FILE CORRESPONDING TO THE SELECTED AIRCRAFT-------------"
            )
        ...
        Button1 = widgets.Button(
            description="WEIGHT SAVING",
            tooltip="MODIFY THE AIRCRAFT OWE",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        ...
        Button2 = widgets.Button(
            description="SFC",
            tooltip="MODIFY THE AIRCRAFT Specific Fuel Consumption",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        Button2.on_click(self.SFC_UI)
        Button3 = widgets.Button(
            description="DRAG SAVING",
            tooltip="MODIFY THE AIRCRAFT DRAG",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        Button3.on_click(self.Drag_Saving_UI)
        Button4 = widgets.Button(
            description="MTOW INCREASE",
            tooltip="MODIFY THE AIRCRAFT MTOW",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        ...
        Button5 = widgets.Button(
            description="FUSELAGE SIMPLE STRETCH ",
            tooltip="MODIFY THE FUSELAGE GEOMETRY",
            layout=layout_button,
            style=dict(button_color="#ebebeb"),
        )
        ...
        box_H = widgets.HBox(
            children=[Button1, Button2, Button3, Button4], layout=layout_H
        )
        box_H2 = widgets.HBox(children=[Button5, Button6], layout=layout_H2)

        Button1_run = widgets.Button(
            description="RUN - STEP 1 ",
            tooltip="Launch the ID analysis of level STEP 1",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button1_run.on_click(self.INCREMENTAL_DEVELOPMENT_STEP1)

        Button2_run = widgets.Button(
            description="RUN - STEP 2",
            tooltip="Launch the ID analysis of level STEP 2",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button2_run.on_click(self.INCREMENTAL_DEVELOPMENT_STEP2)

        Button3_run = widgets.Button(
            description="RUN - STEP 3",
            tooltip="Launch the ID analysis of level STEP 3",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button3_run.on_click(self.INCREMENTAL_DEVELOPMENT_STEP3)

        box_H_Button_Run = widgets.HBox(
            children=[Button1_run, Button2_run, Button3_run], layout=layout_H3
        )
        # ---------------------------------------------------------------------------------------------------------------
        buttonHOME = widgets.Button(description="")
        buttonHOME.icon = "fa-home"
        ...
        accordion_box = widgets.HBox(
            children=[accordion1, accordion2, accordion3],
        ...
        def info_message(event):
            with output:
                ...
                if len(output.outputs) > 0:
                    ...
                    print(
                        "Space dedicated to the evaluation of Incremental Developments.\n"
                        ...
                        "4-The results are in OUTPUT_FILE folder: STEP1_AC, STEP2_AC and STEP3_AC\n"
                        "Between modifications it is necessary to run the software again to choose the reference AC. "
                        "If not, the modifications are accumulated\n"
                    )
    ...
    def Weight_Saving_UI(self, event):
        ...
        self.OWES_1 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=0.001,
            value=self.OWE_REF,
            disabled=True,
            description="OWE (Kg) ",
            description_tooltip="OWE OF THE REFERENCE AIRCRAFT",
            style=style,
            layout=layout,
        )
        self.OWES_2 = widgets.BoundedFloatText(
            min=-100000,
            max=0,
            step=0.001,
            value=0,
            disabled=False,
            description=" ∆(OWE)",
            description_tooltip="THE DELTA OWE SAVING",
            style=style,
            layout=layout,
        )
        self.OWES_2.observe(self.delta_OWE_percent, names="value")

        self.OWES_3 = widgets.BoundedFloatText(
            min=-100,
            max=0,
            step=0.001,
            value=0,
            disabled=False,
            description="%∆(OWE)",
            description_tooltip="THE % OF DELTA OWE SAVING",
            style=style,
            layout=layout,
        )
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE OWE MODIFICATIONS",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button.on_click(self.Weight_Saving)
        self.OWES_box = widgets.VBox(
            children=[title, self.OWES_1, self.OWES_2, self.OWES_3, Button],
            layout=layout_box,
        )
    ...
    def Weight_Saving(self, event):
        ...
        self.ID_Type_percent = self.ID_Type_percent + [
            "Weight Saving: " + str(round(self.OWES_3.value, 1)) + "%"
        ]
    ...
    def SFC_UI(self, event):
        ...
        self.SFC_1 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.001,
            value=self.List_SFC[0],
            disabled=True,
            description="ENGINE SFC (kg/N/s)",
            description_tooltip="THE SFC OF THE AIRCRAFT ENGINE",
            style=style,
            layout=layout,
        )
        self.SFC_2 = widgets.BoundedFloatText(
            min=-100,
            max=100,
            step=0.001,
            value=0,
            disabled=False,
            description=" ∆(SFC)",
            description_tooltip="THE DELTA SFC",
            style=style,
            layout=layout,
        )
        self.SFC_2.observe(self.delta_SFC_percent, names="value")
        self.SFC_3 = widgets.BoundedFloatText(
            min=-100,
            max=100,
            step=0.001,
            value=0,
            disabled=False,
            description="%∆(SFC)",
            description_tooltip="THE % OF DELTA SFC",
            style=style,
            layout=layout,
        )
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE SFC MODIFICATION",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button.on_click(self.SFC)
        self.SFC_box = widgets.VBox(
            children=[title, self.SFC_1, self.SFC_2, self.SFC_3, Button],
            layout=layout_box,
        )
    ...
    def SFC(self, event):
        ...
        self.ID_Type_percent = self.ID_Type_percent + [
            "SFC: " + str(round(self.SFC_3.value, 1)) + "%"
        ]
    ...
    def NEO_UI_1(self, event):
        ...
        self.EngineMass = self.Para_DataNEO["data:weight:propulsion:engine:mass"].value[
            0
        ]
        self.PropulsionMass = self.Para_DataNEO["data:weight:propulsion:mass"].value[0]
        self.NacelleWetArea = self.Para_DataNEO[
        ...
        layout = widgets.Layout(
            width="100%", height="50px", justify_content="space-around"
        )
        style = style = {"description_width": "initial"}

        title = widgets.HTML(value=" <b>MODIFY NEO </b>")

        self.NEO_1 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=0.001,
            value=round(self.List_SFC[0], 10),
            disabled=True,
            description="Engine SFC (kg/N/s)",
            description_tooltip="THE SFC OF THE AIRCRAFT ENGINE",
            style=style,
        ...
        self.NEO_2 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=1,
            value=round(self.EngineMass, 5),
            disabled=True,
            description="Engine Mass [kg]",
            description_tooltip="Engine mass",
            style=style,
            layout=layout,
        )
        self.NEO_3 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=1,
            value=round(self.NacelleWetArea, 5),
            disabled=True,
            description="Nacelle Wetted Area[m^2]",
            description_tooltip="Engine nacelle diameter",
            style=style,
            layout=layout,
        )

        self.NEO_11 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=0.001,
            value=0,
            disabled=True,
            description="NEW Engine SFC (kg/N/s)",
            description_tooltip="The NEW SFC of the aircraft",
            style=style,
            layout=layout,
        )
        self.NEO_22 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=1,
            value=0,
            disabled=True,
            description="NEW Engine Mass [kg]",
            description_tooltip="New Engine mass",
            style=style,
            layout=layout,
        )
        self.NEO_33 = widgets.BoundedFloatText(
            min=0,
            max=1000000,
            step=1,
            value=0,
            disabled=True,
            description="NEW Nacelle Wetted Area[m^2]",
            description_tooltip="New Engine nacelle diameter",
            style=style,
            layout=layout,
        )

        self.NEO_1a = widgets.BoundedFloatText(
            min=-10000,
            max=100000,
            step=1,
            value=0,
            disabled=True,
            description="∆(SFC)",
            description_tooltip="Delta SFC",
            style=style,
            layout=layout,
        )
        self.NEO_1b = widgets.BoundedFloatText(
            min=-10000,
            max=100000,
            step=1,
            value=0,
            disabled=False,
            description="∆%(SFC)",
            description_tooltip="% SFC",
            style=style,
            layout=layout,
        )

        self.NEO_2a = widgets.BoundedFloatText(
            min=-100000,
            max=100000,
            step=1,
            value=0,
            ...
            description_tooltip="Delta Engine Mass",
            style=style,
            layout=layout,
        )
        self.NEO_2b = widgets.BoundedFloatText(
            min=-100000,
            max=100000,
            step=1,
            value=0,
        ...
        self.NEO_3a = widgets.BoundedFloatText(
            min=-10000,
            max=100000,
            step=1,
            value=0,
            ...
            description_tooltip="Delta Nacelle Wetted Area",
            style=style,
            layout=layout,
        )
        self.NEO_3b = widgets.BoundedFloatText(
            min=-10000,
            max=100000,
            step=1,
            value=0,
            disabled=False,
            description="∆%(Wetted Area)",
            description_tooltip="% Nacelle Wetted Area",
            style=style,
            layout=layout,
        )
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE NEO MODIFICATION",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button.on_click(self.NEO_save_1)
        Button_variation = widgets.Button(
            description="Update", tooltip="Update values", layout=layout_button
        )
        Button_variation.on_click(self.percent_NEO_S1_delta)

        self.NEO_V1 = widgets.VBox(
            children=[self.NEO_1, self.NEO_1b, self.NEO_11, self.NEO_1a],
            layout=widgets.Layout(
        ...
        self.NEO_V2 = widgets.VBox(
            children=[self.NEO_2, self.NEO_2b, self.NEO_22, self.NEO_2a],
            layout=widgets.Layout(
                border="5px solid black",
                padding="10px",
                align_items="center",
        ...
        self.NEO_V3 = widgets.VBox(
            children=[self.NEO_3, self.NEO_3b, self.NEO_33, self.NEO_3a],
            layout=widgets.Layout(
                border="5px solid black",
                padding="10px",
                align_items="center",
        ...
        self.NEO_Horizontal = widgets.HBox(
            children=[self.NEO_V1, self.NEO_V2, self.NEO_V3],
            layout=widgets.Layout(
                border="0px solid black",
                padding="0px",
                width="100%",
        ...
        self.NEO_box = widgets.VBox(
            children=[title, self.NEO_Horizontal, Button_variation, Button],
            layout=widgets.Layout(
                border="5px solid black",
                padding="10px",
                align_items="center",
    ...
    def NEO_save_1(self, event):
        ...
        self.ID_Type_percent = self.ID_Type_percent + [
            "NEO// "
            + "SFC_neo:"
            + str(round(self.NEO_1b.value, 1))
            + "%"
            + ", EngineMass_neo:"
            + str(round(self.NEO_2b.value, 1))
            + "%"
            + +", WetArea_neo:"
            + str(round(self.NEO_3b.value, 1))
            + "%"
        ]
        NEO_NEW = self.NEO_11.value  # +self.List_SFC[0] # new sfc
        self.List_SFC.append(NEO_NEW)
        nacelle_old_wetted_area = self.Para_DataNEO[
            "data:geometry:propulsion:nacelle:wetted_area"
        ].value[0]
        self.Para_DataNEO[
            "data:weight:propulsion:engine:mass"
        ].value = self.NEO_22.value  # Both engines
        self.Para_DataNEO[
            "data:geometry:propulsion:nacelle:wetted_area"
        ].value = self.NEO_33.value  # One engine
        self.Para_DataNEO["data:weight:propulsion:mass"].value = (
            self.PropulsionMass - self.EngineMass + self.NEO_22.value
        )
        ...
        nac_length = self.Para_DataNEO["data:geometry:propulsion:nacelle:length"].value[
            0
        ]
        wet_area_nac = self.Para_DataNEO[
            "data:geometry:propulsion:nacelle:wetted_area"
        ].value
        ...
        cd0_int_nac = 0.0002
        cd0_nac = n_engines * (
            kn_cd0_nac * cf_nac * wet_area_nac / wing_area + cd0_int_nac
        )

        # Compute Cd0Total() from FAST-OAD.CS25
        wet_area_total = (
            self.Para_DataNEO["data:geometry:aircraft:wetted_area"].value[0]
            - nacelle_old_wetted_area * n_engines
            + wet_area_nac * n_engines
        )
        cd0_wing = np.array(
            self.Para_DataNEO["data:aerodynamics:wing:cruise:CD0"].value[:]
        )
        cd0_fus = np.array(
            self.Para_DataNEO["data:aerodynamics:fuselage:cruise:CD0"].value[:]
        )
        cd0_ht = np.array(
            self.Para_DataNEO["data:aerodynamics:horizontal_tail:cruise:CD0"].value[:]
        )
        cd0_vt = np.array(
            self.Para_DataNEO["data:aerodynamics:vertical_tail:cruise:CD0"].value[:]
        )
        cd0_pylon = np.array(
        ...
        ].value = cd0_total_clean
        self.Para_DataNEO["data:aerodynamics:aircraft:cruise:CD0:parasitic"].value = (
            cd0_total - cd0_total_clean
        )
        self.Para_DataNEO.save()

        k_cd = self.Para_DataNEO["tuning:aerodynamics:aircraft:cruise:CD:k"].value[0]
        offset_cd = self.Para_DataNEO[
            "tuning:aerodynamics:aircraft:cruise:CD:offset"
        ].value[0]
        k_winglet_cd = self.Para_DataNEO[
            "tuning:aerodynamics:aircraft:cruise:CD:winglet_effect:k"
        ].value[0]
        offset_winglet_cd = self.Para_DataNEO[
            "tuning:aerodynamics:aircraft:cruise:CD:winglet_effect:offset"
        ].value[0]
        cl = np.array(
            self.Para_DataNEO["data:aerodynamics:aircraft:cruise:CL"].value[:]
        )
        cd0_total = np.array(cd0_total)
        cd_trim = np.array(
            self.Para_DataNEO["data:aerodynamics:aircraft:cruise:CD:trim"].value[:]
        )
        cd_c = np.array(
            self.Para_DataNEO[
        ...
        self.Para_DataNEO["data:aerodynamics:aircraft:cruise:L_D_max"].value = (
            optimum_Cz / optimum_Cd
        )
        ...
        if (
            self.Para_DataNEO["data:geometry:propulsion:nacelle:wetted_area"].value
            != self.NEO_3.value
        ):
            self.Para_DataNEO.save()
    ...
    def Drag_Saving_UI(self, event):
        ...
        self.DRAG_1 = widgets.BoundedFloatText(
            min=0,
            max=60,
            step=0.001,
            value=round(finesse, 2),
            disabled=True,
            description="(L/D)_max",
            description_tooltip="max lift/drag ratio in cruise conditions",
            style=style,
            layout=layout,
        )
        ...
        self.DRAG_2 = widgets.BoundedFloatText(
            min=-100,
            max=100,
            step=0.001,
            value=0,
            disabled=False,
            description=" %∆(CD)",
            description_tooltip="%∆ (drag coefficient in cruise conditions)",
            style=style,
            layout=layout,
        )
        self.DRAG_2.observe(self.percent_drag_finesse, names="value")

        self.DRAG_3 = widgets.BoundedFloatText(
            min=-20,
            max=20,
            step=0.001,
            value=0,
        ...
        self.DRAG_4 = widgets.BoundedFloatText(
            min=-100,
            max=100,
            step=0.001,
            value=0,
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE DRAG MODIFICATION",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button.on_click(self.Drag_Saving)
        self.CD_box = widgets.VBox(
            children=[title, box1, box2, box4, Button], layout=layout_box
        )
        display(self.CD_box)
    ...
    def Drag_Saving(self, event):
        ...
        self.ID_Type_percent = self.ID_Type_percent + [
            "Drag Cd: " + str(round(self.DRAG_2.value, 1)) + "%"
        ]
    ...
    def MTOW_Increase_UI(self, event):
        ...
        self.MTOW_1 = widgets.BoundedFloatText(
            ...
            disabled=True,
            description="MTOW (Kg) ",
            description_tooltip="MTOW OF THE REFERENCE AIRCRAFT",
            style=style,
            layout=layout,
        )
        self.MTOW_2 = widgets.BoundedFloatText(
            ...
            disabled=False,
            description=" ∆(MTOW)",
            description_tooltip="THE DELTA MTOW INCREASE",
            style=style,
            layout=layout,
        )
        ...
        self.MTOW_3 = widgets.BoundedFloatText(
            ...
            disabled=False,
            description="%∆(MTOW)",
            description_tooltip="THE % OF DELTA MTOW INCREASE",
            style=style,
            layout=layout,
        )
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE MTOW MODIFICATIONS",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button.on_click(self.MTOW_Saving)
        self.MTOW_box = widgets.VBox(
            children=[title, self.MTOW_1, self.MTOW_2, self.MTOW_3, Button],
            layout=layout_box,
        )
    ...
    def MTOW_Saving(self, event):
        ...
        self.ID_Type_percent = self.ID_Type_percent + [
            "MTOW: " + str(round(self.MTOW_3.value, 1)) + "%"
        ]
    ...
    def Fuselage_Stretch_UI(self, event):
        ...
        self.Fuselage_Weight_ref = para_data[
        ...
        self.WettedArea_Aircraft_ref = para_data[
            "data:geometry:aircraft:wetted_area"
        ].value[0]
        self.WettedArea_Fuse_ref = para_data[
        ...
        # Compute the coefficient k from the expression of the aircraft CD0 implemented in FAST-OAD
        CD0_clean = statistics.mean(
            para_data["data:aerodynamics:aircraft:cruise:CD0:clean"].value
        )
        CD0_parasitic = statistics.mean(
            para_data["data:aerodynamics:aircraft:cruise:CD0:parasitic"].value
        )
        ...
        layout_button = widgets.Layout(
            width="40%", height="40px", border="4px solid black"
        )
        layout_H = widgets.Layout(
            border="4px solid black", padding="10px", align_items="center", width="100%"
        )
        ...
        self.FUSE_1 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.001,
            value=round(FUSE_1, 2),
            disabled=True,
            description="fuselage:length (m)",
            description_tooltip="total fuselage length (m)",
            style=style,
            layout=layout,
        )
        self.FUSE_2 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.001,
            value=round(FUSE_2, 4),
            disabled=True,
            description="fuselage:cruise:CD0_mean",
            description_tooltip="The mean CD0 of the fuselage in cruise",
            style=style,
            layout=layout,
        )
        self.FUSE_3 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.001,
            value=round(FUSE_3, 4),
            disabled=True,
            description="aircraft:cruise:CD0_mean",
            description_tooltip="the mean CD0 of the aircraft in cruise",
            style=style,
            layout=layout,
        )
        self.FUSE_4 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.001,
            value=round(FUSE_4, 4),
            disabled=True,
            description="aircraft:cruise:CD_mean",
            description_tooltip="the mean CD0 of the aircraft in cruise",
            style=style,
            layout=layout,
        )
        self.FUSE_5 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.001,
            value=round(FUSE_5, 2),
            disabled=True,
            description="aircraft:cruise:L_D_max",
            description_tooltip="the max lift_drag ratio",
            style=style,
            layout=layout,
        )
        ...
        self.FUSE_6 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=round(FUSE_6, 0),
            disabled=True,
            description="NPAX1",
            description_tooltip="number of passengers",
            style=style,
        ...
        self.FUSE_7 = widgets.BoundedFloatText(
            min=0,
            max=60000,
            step=1,
            value=round(FUSE_7, 3),
            disabled=True,
            description="OWE (Kg)",
            description_tooltip="Empty Operating Weight of the aircraft",
            style=style,
            layout=layout,
        )
        box3 = widgets.HBox(children=[self.FUSE_6, self.FUSE_7], layout=layout_H)

        self.FUSE_16 = widgets.BoundedFloatText(
            min=0,
            max=60000,
            step=1,
            value=round(FUSE_16, 3),
            disabled=True,
            description="aircraft:payload (Kg)",
            description_tooltip="design payload weight",
            style=style,
            layout=layout,
        )
        self.FUSE_17 = widgets.BoundedFloatText(
            min=0,
            max=60000,
            step=1,
            value=round(FUSE_17, 3),
            disabled=True,
            description="aircraft:max_payload(Kg)",
            description_tooltip="design max payload weight",
            style=style,
            layout=layout,
        )
        ...
        box4 = widgets.VBox(
            children=[self.FUSE_1, box1, box2, box3, box11], layout=layout_V
        )

        self.FUSE_8 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.01,
            value=0,
            disabled=False,
            description=" ∆ fuselage:length (m)",
            description_tooltip="variation of total fuselage length (m)",
            style=style,
            layout=layout,
        )
        self.FUSE_8.observe(self.delta_length_percent, names="value")

        self.FUSE_9 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.01,
            value=0,
        ...
        self.FUSE_10 = widgets.BoundedFloatText(
            min=-100,
            max=100,
            step=0.01,
            value=0,
        ...
        self.FUSE_11 = widgets.BoundedFloatText(
            min=-100,
            max=100,
            step=0.01,
            value=0,
        ...
        self.FUSE_12 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=1,
            value=0,
        ...
        self.FUSE_13 = widgets.BoundedFloatText(
            min=0,
            max=1000,
            step=0.01,
            value=0,
        ...
        self.FUSE_14 = widgets.BoundedFloatText(
            min=0,
            max=60000,
            step=0.01,
            value=0,
        ...
        self.FUSE_15 = widgets.BoundedFloatText(
            min=0,
            max=100,
            step=0.01,
            value=0,
        ...
        self.FUSE_18 = widgets.BoundedFloatText(
            min=0,
            max=60000,
            step=1,
            value=0,
            disabled=True,
            description="∆ aircraft:max_payload(Kg)",
            description_tooltip="variation of the  design max payload weight",
            style=style,
            layout=layout,
        )
        self.FUSE_19 = widgets.BoundedFloatText(
            min=0,
            max=60000,
            step=1,
            value=0,
            disabled=True,
            description="∆ aircraft:max_payload(%)",
            description_tooltip="∆ variation of the  design max payload weight(%)",
            style=style,
            layout=layout,
        )
        ...
        Button = widgets.Button(
            description="SAVE",
            tooltip="SAVE THE FUSELAGE MODIFICATIONS ",
            layout=layout_button,
            style=dict(button_color="#33ffcc"),
        )
        Button.on_click(self.Fuselage_Stretch)

        self.FUSE_box = widgets.VBox(
            children=[title, box4, box6, box10, Button], layout=layout_box
        )
    ...
    def delta_length_percent(self, change):
        ...
        miscellaneous_weight_ref = (
            self.Fuselage_Weight_ref + self.Paint_Weight_ref + self.Furniture_Weight_ref
        )
        miscellaneous_weight_new = (
            Fuselage_Weight_new + Paint_Weight_new + Furniture_weight_new
        )
    ...
    def percent_length_delta(self, change):
        ...
        self.WettedArea_Aircraft_new = (
            WettedArea_Aircraft_ref
            - self.WettedArea_Fuse_ref
    ...
    def Fuselage_Stretch(self, event):
        ...
        self.ID_Type_percent = self.ID_Type_percent + [
            "Fuselage Simple Stretch: " + str(round(self.FUSE_9.value, 1)) + "%"
        ]
        # new length
        ...
        para_data["data:geometry:aircraft:wetted_area"].value[
            0
        ] = self.WettedArea_Aircraft_new
        para_data["data:geometry:fuselage:wetted_area"].value[
            0
        ] = self.WettedArea_Fuse_new
        ...
        display(self.ID2_box)
        print(
            "-------------------------------------FUSELAGE STRETCH SAVED----------------------------------------"
        )

    def BlockFuel_ID(self, OWE, PL, RANGE, coefficient, reserve):
        BF_DOC = np.exp((1000 * RANGE * 1.852) / coefficient) * (OWE + PL + reserve) - (
            OWE + PL + reserve
        )
        return BF_DOC
    ...
    def DesingRange_ID(self, OWE, PL, MTOW, MFW, coefficient, reserve):
        if PL >= (MTOW - OWE - MFW):
            RANGE_DESIGN = (
                coefficient * np.log(MTOW / (OWE + PL + reserve)) / 1000 / 1.852
            )  # NM
        else:
            RANGE_DESIGN = 0
    ...
    def INCREMENTAL_DEVELOPMENT_STEP1(self, event):
        ...
        Percent_BFPAX = (
            100 * ((BF_para / Pax_para) - (BF_ref / Pax_ref)) / (BF_ref / Pax_ref)
        )
        ...
        data = [
            ...
            [
                ...
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_BF, 2)) + "</b>",
            ],
            [
                "<i>BF/Npax = </i>  "
                + "<b>"
                + str(round(BF_ref / Pax_ref, 2))
                + "</b>"
                + "  [kg/pax]",
                "<i>BF/Npax = </i>  "
                + "<b>"
                + str(round(BF_para / Pax_para, 2))
                + "</b>"
                + "  [kg/pax]",
                "<b>" + str(round(Percent_BFPAX, 2)) + "</b>",
            ],
            [
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                + str(round(SR_ref, 3))
                + "</b>"
                + "  [NM/kg]",
                ...
                + "</b>"
                + "  [NM/kg]",
                "<b>" + str(round(Percent_SR, 2)) + "</b>",
            ],
            [
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_ref, 0))
                + "</b>"
                + "  [kg]",
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_para, 0))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_Mass, 2)) + "</b>",
            ],
        ]

        font_size = "16px"  # Adjust the font size as desired
        html_data = [
            [f'<span style="font-size: {font_size};">{value}</span>' for value in row]
            for row in data
        ]

        table_widget = widgets.GridBox(
            children=[widgets.HTML(value) for row in html_data for value in row],
            layout=widgets.Layout(
                grid_template_columns="repeat(3, auto)", width="100%"
            ),
        )
        ...
        data_fuel = [
            [
                "<u>MFW_ref [kg]</u>",
                "<u>Available_ref [kg]</u>",
                "<u>Design_ref [kg]</u>",
                "<u>Design/MFW_ref %</u>",
                "<u>Design/Available_ref %</u>",
            ],
            [
                str(round(MFW_ref, 0)),
                str(round(FUEL_AVAILABLE_ref, 0)),
                str(round(BF_design_ref, 0)),
                str(round(MAX_BF_MISSION_BF_percent_ref, 2)),
                str(round(AVAILABLE_BF_MISSION_BF_percent_ref, 2)),
            ],
            [
                "<u>MFW_S1 [kg]</u>",
                "<u>Available_S1 [kg]</u>",
                "<u>Design_S1 [kg]</u>",
                "<u>Design/MFW_S1 %</u>",
                "<u>Design/Available_S1 %</u>",
            ],
            [
                str(round(MFW_para, 0)),
                str(round(FUEL_AVAILABLE_para, 0)),
                str(round(BF_design_para, 0)),
                str(round(MAX_BF_MISSION_BF_percent_para, 2)),
                str(round(AVAILABLE_BF_MISSION_BF_percent_para, 2)),
            ],
        ]
        ...
        table_widget_fuel = widgets.GridBox(
            children=[widgets.HTML(value) for row in html_data_fuel for value in row],
            layout=widgets.Layout(
                grid_template_columns="repeat(5, auto)", width="100%"
            ),
        )
        ...
        fig = self.OAD.para_payload_range(
            ac_ref, SFC_ref, var_owe=None, var_mtow=None, name="REF AC", Color="blue"
        )
        fig = self.OAD.para_payload_range(
            ac_para,
            SFC_para,
        ...
        if "Fuselage Simple Stretch" in self.ID_Type:
            C_V_PL_info_Pax = widgets.VBox(
                children=[C_paraPaxref, C_paraPaxS1],
                layout=widgets.Layout(
                    border="0px solid black",
                    align_items="center",
                    padding="0px",
        ...
        C_V_PL = widgets.VBox(
            children=[C_V_PL_info_Pax, fig, table_widget_fuel],
            layout=widgets.Layout(
                border="0px solid black",
                align_items="center",
                padding="0px",
        ...
        fig2 = self.OAD.Npax_BF_Diagramm(
            ac_para, SFC_para, "NEW AC", fig=fig2, Color="red"
        )

        C_V_BlockFuel = widgets.VBox(
            children=[fig2, table_widget, infobox],
            layout=widgets.Layout(
                border="0px solid black",
                align_items="center",
                padding="0px",
        ...
        fig3 = self.OAD.WeightBar_Diagramm(
            ac_para, SFC_para, "STEP 1", fig=fig3, Color="red"
        )
    ...
    def INCREMENTAL_DEVELOPMENT_STEP2(self, event):
        ...
        EngineMasses_percent = (
            1 - (EngineMasses_ref - EngineMasses_step1) / EngineMasses_ref
        )
        if "Fuselage Simple Stretch" in self.ID_Type:
        ...
        # by engine variation + also the tuning k factor of the engine mass. Risk of exaggerated results.
        ...
        PL_DOC_para_S1 = data_para_S1["data:weight:aircraft:payload"].value[
            0
        ]  # +10*Pax_para_S1
        ...
        reserve_para_S1 = data_para_S1["data:mission:MTOW_mission:reserve:fuel"].value[
            0
        ]
        BF_para_S1 = self.BlockFuel_ID(
            OWE_para_S1,
            PL_DOC_para_S1,
            Range_DOC_para_S1,
            coefficient_para_S1,
        ...
        Percent_BFPAX_S1 = (
            100 * ((BF_para_S1 / Pax_para_S1) - (BF_ref / Pax_ref)) / (BF_ref / Pax_ref)
        )
        ...
        data = [
            ...
            [
                ...
                "<i>Block Fuel = </i>  "
                + "<b>"
                + str(round(BF_para_S1, 0))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_BF_S1, 2)) + "</b>",
            ],
            [
                "<i>BF/Npax = </i>  "
                + "<b>"
                ...
                "<i>BF/Npax = </i>  "
                + "<b>"
                + str(round(BF_para_S1 / Pax_para_S1, 2))
                + "</b>"
                + "  [kg/pax]",
                "<b>" + str(round(Percent_BFPAX_S1, 2)) + "</b>",
            ],
            [
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                ...
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                + str(round(SR_para_S1, 3))
                + "</b>"
                + "  [NM/kg]",
                "<b>" + str(round(Percent_SR_S1, 2)) + "</b>",
            ],
            [
                "<i>Mean Mass = </i>  "
                + "<b>"
                ...
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_para_S1, 0))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_Mass_S1, 2)) + "</b>",
            ],
        ]
        font_size = "16px"  # Adjust the font size as desired
        html_data = [
        ...
        table_widget_S1 = widgets.GridBox(
            children=[widgets.HTML(value) for row in html_data for value in row],
            layout=widgets.Layout(
                grid_template_columns="repeat(3, auto)", width="100%"
            ),
        ...
        Percent_BFPAX_S2 = (
            100 * ((BF_para_S2 / Pax_para_S2) - (BF_ref / Pax_ref)) / (BF_ref / Pax_ref)
        )
        ...
        data = [
            ...
            [
                ...
                "<i>Block Fuel = </i>  "
                + "<b>"
                + str(round(BF_para_S2, 0))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_BF_S2, 2)) + "</b>",
            ],
            [
                "<i>BF/Npax = </i>  "
                + "<b>"
                ...
                "<i>BF/Npax = </i>  "
                + "<b>"
                + str(round(BF_para_S2 / Pax_para_S2, 2))
                + "</b>"
                + "  [kg/pax]",
                "<b>" + str(round(Percent_BFPAX_S2, 2)) + "</b>",
            ],
            [
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                ...
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                + str(round(SR_para_S2, 3))
                + "</b>"
                + "  [NM/kg]",
                "<b>" + str(round(Percent_SR_S2, 2)) + "</b>",
            ],
            [
                "<i>Mean Mass = </i>  "
                + "<b>"
                ...
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_para_S2, 0))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_Mass_S2, 2)) + "</b>",
            ],
        ]
        html_data = [
            [f'<span style="font-size: {font_size};">{value}</span>' for value in row]
        ...
        table_widget_S2 = widgets.GridBox(
            children=[widgets.HTML(value) for row in html_data for value in row],
            layout=widgets.Layout(
                grid_template_columns="repeat(3, auto)", width="100%"
            ),
        ...
        data_fuel = [
            [
                "<u>MFW_ref [kg]</u>",
                "<u>Available_ref [kg]</u>",
                "<u>Design_BF_ref [kg]</u>",
                "<u>Design_BF_ref/MFW_ref %</u>",
                "<u>Design_BF_ref/Available_ref %</u>",
            ],
            [
                str(round(MFW_ref, 0)),
                str(round(FUEL_AVAILABLE_ref, 0)),
            ...
            [
                ...
                "<u>Available_S1 [kg]</u>",
                "<u>Design_BF_S1 [kg]</u>",
                "<u>Design_BF_S1/MFW_S1 %</u>",
                "<u>Design_BF_S1/Available_S1 %</u>",
            ],
            [
                str(round(MFW_para_S1, 0)),
                str(round(FUEL_AVAILABLE_para_S1, 0)),
                str(round(BF_design_para_S1, 0)),
                str(round(MAX_BF_MISSION_BF_percent_para_S1, 2)),
                str(round(AVAILABLE_BF_MISSION_BF_percent_para_S1, 2)),
            ],
            [
                "<u>MFW_S2 [kg]</u>",
                "<u>Available_S2 [kg]</u>",
                "<u>Design_BF_S2 [kg]</u>",
                "<u>Design_BF_S2/MFW_S2 %</u>",
                "<u>Design_BF_S2/Available_S2 %</u>",
            ],
            [
                str(round(MFW_para_S2, 0)),
                str(round(FUEL_AVAILABLE_para_S2, 0)),
                str(round(BF_design_para_S2, 0)),
                str(round(MAX_BF_MISSION_BF_percent_para_S2, 2)),
                str(round(AVAILABLE_BF_MISSION_BF_percent_para_S2, 2)),
            ],
        ]
        ...
        fig2 = self.OAD.Npax_BF_Diagramm(ac_ref, SFC_ref, name="REF AC", Color="blue")
        fig2 = self.OAD.Npax_BF_Diagramm(
            ac_para_S1, SFC_para_S1, "STEP 1", fig=fig2, Color="red"
        )
        fig2 = self.OAD.Npax_BF_Diagramm(
            ac_para_S2, SFC_para_S2, name="STEP 2", fig=fig2, Color="green"
        )

        C_V_BlockFuel = widgets.VBox(
            children=[fig2, table_widget_S1, table_widget_S2, infobox],
            layout=widgets.Layout(
                border="1px solid black",
                align_items="center",
                padding="2px",
        ...
        fig3 = self.OAD.WeightBar_Diagramm(ac_ref, SFC_ref, name="REF AC", Color="blue")
        fig3 = self.OAD.WeightBar_Diagramm(
            ac_para_S1, SFC_para_S1, "STEP 1", fig=fig3, Color="red"
        )
        fig3 = self.OAD.WeightBar_Diagramm(
            ac_para_S2, SFC_para_S2, name="STEP 2", fig=fig3, Color="green"
        )
    ...
    def INCREMENTAL_DEVELOPMENT_STEP3(self, event):
        ...
        PL_DOC_para_S2 = data_para_S2["data:weight:aircraft:payload"].value[
            0
        ]  # +Pax_para_S2*10
        ...
        reserve_para_S2 = data_para_S2["data:mission:MTOW_mission:reserve:fuel"].value[
            0
        ]
        BF_para_S2 = self.BlockFuel_ID(
            OWE_para_S2,
        ...
        PL_DOC_para_S3 = data_para_S3["data:weight:aircraft:payload"].value[
            0
        ]  # +Pax_para_S3*10
        ...
        reserve_para_S3 = data_para_S3["data:mission:MTOW_mission:reserve:fuel"].value[
            0
        ]
        BF_para_S3 = self.BlockFuel_ID(
            OWE_para_S3,
            PL_DOC_para_S3,
            Range_DOC_para_S3,
            coefficient_para_S3,
        ...
        data = [
            ...
            [
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_ref, 2))
                + "</b>"
                + "  [kg]",
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_para_S1, 2))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_Mass_S1, 2)) + "</b>",
            ],
        ...
        data = [
            ...
            [
                ...
                "<i>BF/Npax = </i>  "
                + "<b>"
                + str(round(BF_para_S2 / Pax_para_S2, 3))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_BFPAX_S2, 2)) + "</b>",
            ],
        ...
        Percent_BFPAX_S3 = (
            100 * ((BF_para_S3 / Pax_para_S3) - (BF_ref / Pax_ref)) / (BF_ref / Pax_ref)
        )
        ...
        data = [
            ...
            [
                ...
                "<i>Block Fuel = </i>  "
                + "<b>"
                + str(round(BF_para_S3, 2))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_BF_S3, 2)) + "</b>",
            ],
            [
                "<i>BF/Npax = </i>  "
                + "<b>"
                ...
                "<i>BF/Npax = </i>  "
                + "<b>"
                + str(round(BF_para_S3 / Pax_para_S3, 2))
                + "</b>"
                + "  [kg/pax]",
                "<b>" + str(round(Percent_BFPAX_S3, 2)) + "</b>",
            ],
            [
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                ...
                "<i>Mean Specific Range = </i>  "
                + "<b>"
                + str(round(SR_para_S3, 3))
                + "</b>"
                + "  [NM/kg]",
                "<b>" + str(round(Percent_SR_S3, 2)) + "</b>",
            ],
            [
                "<i>Mean Mass = </i>  "
                + "<b>"
                ...
                "<i>Mean Mass = </i>  "
                + "<b>"
                + str(round(mass_para_S3, 2))
                + "</b>"
                + "  [kg]",
                "<b>" + str(round(Percent_Mass_S3, 2)) + "</b>",
            ],
        ]
        html_data = [
            [f'<span style="font-size: {font_size};">{value}</span>' for value in row]
        ...
        table_widget_S3 = widgets.GridBox(
            children=[widgets.HTML(value) for row in html_data for value in row],
            layout=widgets.Layout(
                grid_template_columns="repeat(3, auto)", width="100%"
            ),
        ...
        data_fuel = [
            ...
            [
                ...
                "<u>Available_S3 [kg]</u>",
                "<u>Design_BF_S3 [kg]</u>",
                "<u>Design_BF_S3/MFW_S3 %</u>",
                "<u>Design_BF_S3/Available_S3 %</u>",
            ],
            [
                str(round(MFW_para_S3, 0)),
                str(round(FUEL_AVAILABLE_para_S3, 0)),
                str(round(BF_design_para_S3, 0)),
                str(round(MAX_BF_MISSION_BF_percent_para_S3, 2)),
                str(round(AVAILABLE_BF_MISSION_BF_percent_para_S3, 2)),
            ],
        ]
        ...
        fig2 = self.OAD.Npax_BF_Diagramm(
            ac_para_S2, SFC_para_S2, "STEP 2", fig=fig2, Color="green"
        )
        fig2 = self.OAD.Npax_BF_Diagramm(
            ac_para_S3, SFC_para_S3, "STEP 3", fig=fig2, Color="black"
        )
        ...
        C_V_BlockFuel = widgets.VBox(
            children=[fig2, table_widget_S1, table_widget_S2, table_widget_S3, infobox],
            layout=widgets.Layout(
                border="1px solid black",
                align_items="center",
                padding="2px",
        ...
        self.tab_Analysis_Para = widgets.Tab(
            children=[C_V_PL, C_V_BlockFuel, fig3, fig4, fig5],
            layout=widgets.Layout(
                border="0px solid black",
                align_items="center",
                padding="2px",
    ...
    def GEO3D(self, Model3dFile):
        ...
        with open(xml_data_file, "r") as xml_obj:
            # converting the xml data to a Python ordered dictionary
        ...
        def update_globals(d, namespace):
            for k, v in d.items():
                ...
                if isinstance(v, dict):  # this line checks if v is a dictionary
                    ...
                    xml_parameters[(namespace + k).removesuffix("_#text")] = round(
                        float(v), 5
                    )
            ...
            while count < len(data_file):
                ...
                for i in csm_values:
                    if des in data_file[count] and (i in data_file[count]):
                        val = tempString[
                            tempString.index(i) + 1
                        ]  # finds next word of search word, i.e, the value
                        data_file[count] = data_file[count].replace(
                            val, str(csm_values[i])
                        )  # replaces the value with chosen value
